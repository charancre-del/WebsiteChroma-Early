...
class earlystart_Credential_Badges
{
    ...
    public static function get_location_credentials($post_id) {
        ...
        $schema_data = get_post_meta($post_id, '_earlystart_schema_data', true);
    ...
    public function auto_append_badges($content) {
        ...
        if (!get_option('earlystart_seo_show_credential_badges', true)) {
            return $content;
        }
...
new earlystart_Credential_Badges();
