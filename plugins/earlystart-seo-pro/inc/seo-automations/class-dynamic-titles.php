...
class earlystart_Dynamic_Titles
{
    private $patterns = [];
    ...
    private function get_patterns() {
        ...
        $this->patterns = get_option('earlystart_seo_title_patterns', $this->get_default_patterns());
    ...
    public function filter_title($title) {
        if (!get_option('earlystart_seo_enable_dynamic_titles', true)) {
            return $title;
        }
    ...
    public function register_settings() {
        register_setting('earlystart_title_patterns', 'earlystart_seo_enable_dynamic_titles');
        register_setting('earlystart_title_patterns', 'earlystart_seo_title_patterns');
    }
    ...
    public function render_settings_page() {
        $enabled = get_option('earlystart_seo_enable_dynamic_titles', true);
        $patterns = $this->get_patterns();
        ?>
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                <?php settings_fields('earlystart_title_patterns'); ?>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" name="earlystart_seo_enable_dynamic_titles" 
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="earlystart_seo_title_patterns[<?php echo esc_attr($key); ?>]" 
