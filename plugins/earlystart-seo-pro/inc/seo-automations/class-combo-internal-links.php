...
class earlystart_Combo_Internal_Links
{
    public function __construct() {
        // Add combo links to program single pages
        add_action('earlystart_after_program_content', [$this, 'render_program_city_links']);
        
        // Add combo links to city pages
        add_action('earlystart_after_city_content', [$this, 'render_city_program_links']);
...
new earlystart_Combo_Internal_Links();
