...
class earlystart_Footer_City_Links
{
    ...
    public static function get_cities() {
        $cities = get_transient('earlystart_footer_cities');
        if ($cities !== false) {
            return $cities;
        }
        ...
        set_transient('earlystart_footer_cities', $cities, DAY_IN_SECONDS);
    ...
    public function render_footer_links() {
        if (!get_option('earlystart_seo_show_footer_cities', true)) {
            return;
        }
    ...
    public function register_widget() {
        register_widget('earlystart_City_Links_Widget');
    }
 ...
 * City Links Widget
 */
class earlystart_City_Links_Widget extends WP_Widget
{
    public function __construct() {
        parent::__construct(
            'earlystart_city_links',
            'SEO City Links',
    ...
    public function widget($args, $instance) {
        ...
        $cities = earlystart_Footer_City_Links::get_cities();
...
add_shortcode('city_links', ['earlystart_Footer_City_Links', 'shortcode']);
new earlystart_Footer_City_Links();
