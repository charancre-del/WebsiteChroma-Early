...
class earlystart_Translation_Engine
{
    ...
    public static function ajax_auto_translate_post()
    {
        ...
        try {
            ...
            $translated = self::translate_bulk($fields, 'es', 'Translate for a pediatric therapy website. Use Spanish (Latin American).', $force);
        ...
        switch ($template) {
            case 'page-about.php':
                return [
                    ...
                    'about_stat3_label',
                    'about_stat4_label',
                    'about_educators_title',
                    'about_educators_description',
                    'about_educator1_title',
                    'about_educator1_desc',
                    'about_educator2_title',
                    'about_educator2_desc',
                    'about_educator3_title',
                    'about_educator3_desc',
                    'about_values_title',
                    ...
                    'about_nutrition_title',
                    'about_nutrition_description',
                    'about_nutrition_bullet1_text',
                    'about_nutrition_bullet2_text',
                    'about_nutrition_bullet3_text',
                    'about_philanthropy_title',
                    'about_philanthropy_subtitle',
                    'about_philanthropy_description',
                    'about_philanthropy_bullet1_text',
                    'about_philanthropy_bullet2_text',
                    'about_philanthropy_bullet3_text',
                    'about_cta_title',
            ...
            case 'page-careers.php':
                return [
                    ...
                    'careers_hero_button_text',
                    'careers_culture_title',
                    'careers_culture_description',
                    'careers_benefit1_title',
                    'careers_benefit1_desc',
                    'careers_benefit2_title',
                    'careers_benefit2_desc',
                    'careers_benefit3_title',
                    'careers_benefit3_desc',
                    'careers_cta_title',
                    'careers_cta_description',
                ];
            ...
            case 'page-curriculum.php':
                return [
                    'curriculum_hero_badge',
                    'curriculum_hero_title',
                    'curriculum_hero_description',
                    'curriculum_framework_title',
                    'curriculum_framework_description',
                    'curriculum_pillar_physical_title',
                    'curriculum_pillar_physical_desc',
                    'curriculum_pillar_emotional_title',
                    'curriculum_pillar_emotional_desc',
                    'curriculum_pillar_social_title',
                    'curriculum_pillar_social_desc',
                    'curriculum_pillar_academic_title',
                    'curriculum_pillar_academic_desc',
                    'curriculum_pillar_creative_title',
                    'curriculum_pillar_creative_desc',
                    'curriculum_timeline_badge',
                    'curriculum_timeline_title',
                    'curriculum_timeline_description',
                    'curriculum_stage_foundation_title',
                    'curriculum_stage_foundation_desc',
                    'curriculum_stage_discovery_title',
                    'curriculum_stage_discovery_desc',
                    'curriculum_stage_readiness_title',
                    'curriculum_stage_readiness_desc',
                    'curriculum_env_badge',
                    'curriculum_env_title',
                    'curriculum_env_description',
                    'curriculum_zone_construction_title',
                    'curriculum_zone_construction_desc',
                    'curriculum_zone_atelier_title',
                    'curriculum_zone_atelier_desc',
                    'curriculum_zone_literacy_title',
                    'curriculum_zone_literacy_desc',
                    'curriculum_milestones_title',
                    'curriculum_milestones_subtitle',
                    'curriculum_milestone_tracking_title',
                    'curriculum_milestone_tracking_desc',
                    'curriculum_milestone_tracking_bullet1',
                    'curriculum_milestone_tracking_bullet2',
                    'curriculum_milestone_screenings_title',
                    'curriculum_milestone_screenings_desc',
                    'curriculum_milestone_screenings_bullet1',
                    'curriculum_milestone_screenings_bullet2',
                    'curriculum_milestone_assessments_title',
                    'curriculum_milestone_assessments_desc',
                    'curriculum_milestone_assessments_bullet1',
                    'curriculum_milestone_assessments_bullet2',
                    'curriculum_cta_title',
                    'curriculum_cta_description'
                ];
            case 'page-employers.php':
                return [
                    'employers_hero_badge',
                    'employers_hero_title',
                    'employers_hero_description',
                    'employers_intro_title',
                    'employers_intro_description',
                    'employers_benefit1_title',
                    'employers_benefit1_desc',
                    'employers_benefit2_title',
                    'employers_benefit2_desc',
                    'employers_benefit3_title',
                    'employers_benefit3_desc',
                    'employers_solutions_title',
                    'employers_solutions_desc',
                    'employers_solution1_title',
                    'employers_solution1_desc',
                    'employers_solution1_features',
                    'employers_solution2_title',
                    'employers_solution2_desc',
                    'employers_solution2_features',
                    'employers_solution3_title',
                    'employers_solution3_desc',
                    'employers_solution3_features',
                    'employers_tax_title',
                    'employers_tax_desc',
                    'employers_federal_title',
                    'employers_federal_desc',
                    'employers_state_title',
                    'employers_state_desc',
                    'employers_tax_disclaimer',
                    'employers_cta_title',
                    'employers_cta_desc',
                    'employers_cta_button_text'
                ];
            case 'front-page.php':
                return [
                    // Post meta keys
                    ...
                    'earlystart_home_hero_heading',
                    'earlystart_home_hero_subheading',
                    'earlystart_home_hero_cta_label',
                    'earlystart_home_hero_secondary_label',
                    'earlystart_home_prismpath_eyebrow',
                    'earlystart_home_prismpath_heading',
                    'earlystart_home_prismpath_subheading',
                    'earlystart_home_prismpath_cta_label',
                    'earlystart_home_locations_heading',
                    'earlystart_home_locations_subheading',
                    'earlystart_home_faq_heading',
                    'earlystart_home_faq_subheading'
                ];
            ...
            case 'page-parents.php':
                return [
                    ...
                    'parents_hero_title',
                    'parents_hero_desc',
                    'parents_essentials_title',
                    'parents_essentials_desc',
                    'parents_resource_procare_title',
                    'parents_resource_procare_desc',
                    'parents_resource_procare_button_text',
                    'parents_resource_handbook_title',
                    'parents_resource_handbook_desc',
                    'parents_resource_handbook_button_text',
                    'parents_events_title',
                    'parents_events_desc',
                    'parents_nutrition_title',
                    'parents_nutrition_desc',
                    'parents_safety_title',
                    'parents_safety_desc',
                    'parents_safety1_title',
                    'parents_safety1_desc',
                    'parents_safety2_title',
                    'parents_safety2_desc',
                    'parents_safety3_title',
                    'parents_safety3_desc',
                    'parents_faq_title',
                    'parents_faq_desc',
                    'parents_faq1_question',
                    'parents_faq1_answer',
                    'parents_faq2_question',
                    'parents_faq2_answer',
                    'parents_faq3_question',
                    'parents_faq3_answer',
                    'parents_faq4_question',
                    'parents_faq4_answer',
                    'parents_faq5_question',
                    'parents_faq5_answer',
                    'parents_referral_title',
                    'parents_referral_desc',
                    'parents_referral_button_text'
                ];
