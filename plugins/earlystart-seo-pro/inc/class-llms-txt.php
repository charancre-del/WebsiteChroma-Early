...
class earlystart_LLMs_Txt_Generator
{
    ...
    private function build_content()
    {
        ...
        $output .= "We provide coordinated autism assessment, behavioral assessment, ADHD assessment, ABA therapy, speech therapy, occupational therapy, and early intervention support for children and families.\n";
