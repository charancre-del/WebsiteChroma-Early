...
class earlystart_Post_Newsroom extends earlystart_Advanced_SEO_Meta_Box_Base
{
    /**
     * Get meta box ID
     *
    ...
    {
        return 'earlystart_post_newsroom';
    }
    ...
    {
        if (isset($_POST['earlystart_show_in_newsroom'])) {
            update_post_meta($post_id, '_earlystart_show_in_newsroom', '1');
        } else {
            delete_post_meta($post_id, '_earlystart_show_in_newsroom');
        }
    }
}
