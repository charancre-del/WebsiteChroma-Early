...
class earlystart_Location_Citation_Facts_Meta_Box extends earlystart_Advanced_SEO_Meta_Box_Base
{
    public function get_id()
    {
        return 'earlystart_location_citation_facts';
    }
    ...
    public function render_fields($post)
    {
        ...
        $fallback_facts = earlystart_Fallback_Resolver::get_citation_facts($post->ID);
    ...
    public function save_fields($post_id)
    {
        ...
        foreach ($facts as $fact) {
            ...
            $sanitized_facts[] = [
                'label' => earlystart_Field_Sanitizer::sanitize_text($fact['label']),
                'value' => earlystart_Field_Sanitizer::sanitize_text($fact['value']),
                'source' => isset($fact['source']) ? earlystart_Field_Sanitizer::sanitize_text($fact['source']) : '',
                'context' => isset($fact['context']) ? earlystart_Field_Sanitizer::sanitize_textarea($fact['context']) : '',
