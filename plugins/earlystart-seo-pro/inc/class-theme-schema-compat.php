    ...
    function earlystart_general_content_schema_pro() {
        ...
        if ($override) {
            ...
            if ($override_data) {
                ...
                earlystart_Schema_Registry::register($override_data, ['source' => 'theme-compat-override']);
            } else {
...
function earlystart_location_schema_pro()
{
    ...
    // Social Profiles
    $socials = array();
    if (function_exists('earlystart_global_facebook_url')) $socials[] = earlystart_global_facebook_url();
    if (function_exists('earlystart_global_instagram_url')) $socials[] = earlystart_global_instagram_url();
    if (function_exists('earlystart_global_linkedin_url')) $socials[] = earlystart_global_linkedin_url();
