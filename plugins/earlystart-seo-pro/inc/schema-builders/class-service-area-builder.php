...
class earlystart_Service_Area_Builder
{
    /**
    ...
    public static function build($location_id)
    {
        ...
        // Get circle data
        $circle = earlystart_Fallback_Resolver::get_service_area_circle($location_id);
        if ($circle) {
            $result['areaServed'] = [
                '@type' => 'GeoShape',
        ...
        // Get cities
        $cities = earlystart_Fallback_Resolver::get_service_area_cities($location_id);
