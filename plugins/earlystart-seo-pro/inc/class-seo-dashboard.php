                        ...
                        <td>
                            ...
                            <div>
                                ...
                                <?php elseif ($is_ai_desc): ?>
                                    <span class="earlystart-badge" style="background: #f0f6fc; color: #005a9c; border: 1px solid #c2dbff;">🤖 AI</span>
                                <?php endif; ?>
        ...
        ?>
                <div class="earlystart-schema-block" data-type="<?php echo esc_attr($type); ?>"
                    ...
                    <h3
                        ...
                        <div>
                            <button class="button button-small earlystart-toggle-json" title="Toggle JSON/Form View" style="margin-right: 5px;">
                            ...
                            ?>
                                <tr>
                                    <th scope="row" style="padding: 10px 0; width: 200px;">
                                        ...
                                        <?php if ($is_ai): ?>
                                            <span class="earlystart-ai-badge" title="AI Generated Fallback" style="background: #f0f6fc; color: #005a9c; border: 1px solid #c2dbff; border-radius: 3px; padding: 1px 4px; font-size: 10px; vertical-align: middle; margin-left: 5px;">🤖 AI</span>
                                        <?php endif; ?>
                                    ...
                                    <td style="padding: 10px 0;">
                                        ...
                                        <?php else: ?>
                                                <input type="text" class="earlystart-schema-input regular-text" data-name="<?php echo esc_attr($key); ?>"
                        ...
                        <div id="llm-queries-container">
                            <?php foreach ($target_queries as $query): ?>
                                    <div class="earlystart-repeater-row" style="margin-bottom: 8px;">
                                        <input type="text" class="earlystart-llm-query-input regular-text" value="<?php echo esc_attr($query); ?>"
...
*/page/2/*"><?php echo esc_textarea(get_option('earlystart_validator_exclusions', '')); ?></textarea>
            ...
            ?>
            <div class="earlystart-health-summary" style="display: flex; gap: 20px; align-items: center; margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #2271b1;">
            ...
            <div class="earlystart-inspector-controls">
                ...
                <input type="text" id="earlystart-validator-search" placeholder="Search pages or errors..." style="margin-left: 10px; height: 30px; display:none; width: 200px;">
            ...
            <!-- Bulk Fix Modal -->
            <div id="earlystart-bulk-modal" style="display:none; position:fixed; z-index:99999; left:0; top:0; width:100%; height:100%; overflow:auto; background-color:rgba(0,0,0,0.6); backdrop-filter:blur(2px);">
                <div style="background-color:#fefefe; margin:50px auto; padding:0; border:1px solid #888; width:90%; max-width:1100px; border-radius:8px; box-shadow:0 4px 20px rgba(0,0,0,0.2);">
                    <div style="padding:15px 20px; border-bottom:1px solid #eee; display:flex; justify-content:space-between; align-items:center; background:#f8f9fa; border-radius:8px 8px 0 0;">
                        ...
                        <span id="earlystart-bulk-close" style="color:#aaa; font-size:28px; font-weight:bold; cursor:pointer; line-height:1;">&times;</span>
                    </div>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p><a href="<?php echo admin_url('admin.php?page=earlystart-title-patterns'); ?>" class="button button-secondary">Configure Patterns</a></p>
                        </td>
                    </tr>
                    <tr>
                ...
                <?php else: ?>
                    ...
                    <div class="analysis-details">
                                ...
                                <tbody>
                                    <?php foreach (array_slice($report['suggestions'], 0, 50) as $sug): ?>
                                        <tr>
                                            ...
                                            <td><span class="earlystart-badge" style="background:#fff8e5; color:#856404;"><?php echo esc_html($sug['type'] ?? ''); ?></span></td>
                                            <td><?php echo esc_html($sug['message'] ?? ''); ?></td>
                                            <td><a href="<?php echo admin_url('admin.php?page=earlystart-link-equity'); ?>" class="button button-small">AI Tool</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                        ...
                        <div style="margin-top: 20px; text-align: right;">
                            <a href="<?php echo admin_url('admin.php?page=earlystart-link-equity'); ?>" class="button button-secondary">Open Advanced Link Equity Manager &rarr;</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
                        ...
                        if (empty($patterns)) {
                            ...
                            foreach ($patterns as $pattern => $data) {
                                ...
                                <tr>
                                    ...
                                    <td><span class="earlystart-badge <?php echo $data['type'] === 'Generic' ? 'earlystart-badge-manual' : 'earlystart-badge-auto'; ?>"><?php echo esc_html($data['type']); ?></span></td>
    ...
    private function render_cleanup_tab_content()
    {
        ...
        <div class="earlystart-seo-card" style="background: <?php echo $registry_active ? '#e8f5e9' : '#fff3e0'; ?>; border-left: 4px solid <?php echo $registry_active ? '#00a32a' : '#ff9800'; ?>;">
