...
class Utils
{
    ...
    public static function get_plugin_setting_allowlist(): array
    {
        ...
        return self::normalize_allowlist(array_merge([
            ...
            'earlystart_intake_form_id',
            'earlystart_intake_form_height',
            'earlystart_intake_form_name',
            'earlystart_verification_form_id',
            'earlystart_verification_form_height',
            'earlystart_verification_form_name',
