        ...
        return rest_ensure_response([
            ...
            'data' => [
                ...
                'allowlists' => [
                    ...
                    'plugin_settings' => Utils::get_plugin_setting_allowlist(),
                ],
                'editable_surface_inventory' => [
                    'content_meta' => Utils::get_theme_meta_key_inventory(),
                    'customizer_options' => Utils::get_customizer_option_allowlist(),
                    'theme_mods' => Utils::get_theme_mod_allowlist(),
                    'theme_options' => Utils::get_theme_option_allowlist(),
                    'seo_options' => Utils::get_seo_option_allowlist(),
                    ...
                    'plugin_settings' => Utils::get_plugin_setting_allowlist(),
                    'term_meta' => Utils::get_term_meta_key_inventory(),
                    'universal_value_writers' => [
                        'content.meta.__any',
                        'seo.meta.__any',
                        'customizer.theme_mod.__any',
                        'theme.option.__any',
                        'seo.option.__any',
                        'plugin.setting.__any',
                        'taxonomy.meta.__any',
                    ],
                ],
                'introspection' => [
