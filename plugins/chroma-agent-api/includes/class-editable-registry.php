...
class Editable_Registry
{
    ...
    private static function public_content_meta_keys(): array
    {
        $keys = [
            ...
            'contact_form_email',
            'contact_form_office_label',
            'contact_form_office_address',
            'contact_form_card_title',
            'contact_form_submit_text',
            'contact_form_fallback_intro',
            'contact_form_fallback_call_label',
            'contact_form_fallback_email_label',
            'contact_department_heading',
            'contact_routes_json',
            'contact_corporate_title',
            'contact_corporate_name',
            'contact_corporate_address',
            'contact_corporate_phone',
            'contact_careers_title',
            'contact_careers_description',
            'contact_careers_link_text',
            'contact_careers_link_url',
            'contact_press_title',
            'contact_press_description',
            'contact_press_link_text',
            'contact_press_link_url',
            'contact_locations_heading_plural',
            'contact_locations_heading_singular',
            'contact_locations_heading_empty',
            'contact_locations_description',
            'contact_locations_link_text',
            'faq_hero_eyebrow',
            'faq_hero_heading',
            'faq_hero_highlight',
            'faq_hero_subheading',
            ...
            'faq_cta_heading',
            'faq_cta_text',
            'locations_hero_eyebrow',
            'locations_hero_heading',
            'locations_hero_subheading',
            'locations_clinic_heading',
            'locations_clinic_text',
            'locations_partner_eyebrow',
            'locations_partner_zone_heading',
            'locations_partner_zone_text',
            'locations_inhome_heading',
            'locations_inhome_text',
            'locations_zones_json',
            'locations_zip_heading',
            'locations_zip_text',
            'locations_zip_availability_text',
            'locations_final_heading',
            'locations_final_text',
            'locations_final_cta_label',
            'locations_final_cta_url',
