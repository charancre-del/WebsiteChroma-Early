	...
	<section class="relative bg-white pt-24 pb-20 lg:pt-32 overflow-hidden">
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
			<span
				...
				<?php _e('Our Programs', 'chroma-early-start'); ?>
			</span>
			<h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight fade-in-up">
				<?php _e('Excellence in every stage of', 'chroma-early-start'); ?><br>
				<span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-orange-500">
					<?php _e('Early Development.', 'chroma-early-start'); ?>
				</span>
			</h1>
			<p class="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed fade-in-up">
				<?php _e('From clinical intensive ABA therapy to social-focused summer camps, our programs are designed to meet children exactly where they are in their developmental journey.', 'chroma-early-start'); ?>
			</p>
		</div>
	</section>
							...
							<div class="p-10 flex flex-grow flex-col">
								...
								<div class="mt-auto">
									<a href="<?php the_permalink(); ?>"
										...
										<?php _e('View Program Details', 'chroma-early-start'); ?>
			...
			<div
				...
				<div class="relative z-10 max-w-2xl">
					<h2 class="text-3xl md:text-4xl font-bold mb-6">
						<?php _e('Unsure which program fits?', 'chroma-early-start'); ?></h2>
					<p class="text-rose-100 text-lg">
						<?php _e('Our clinical intake team can help assess your child\'s needs and recommend a personalized development path.', 'chroma-early-start'); ?>
					</p>
				</div>
				<div class="shrink-0 relative z-10">
					<a href="<?php echo esc_url(home_url('/contact/')); ?>"
						...
						<?php _e('Contact Intake Team', 'chroma-early-start'); ?>
					</a>
				</div>
