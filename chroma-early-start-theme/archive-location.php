...
<main class="pt-20">
	...
	<section class="relative pt-24 pb-20 lg:pt-32 bg-white overflow-hidden border-b border-stone-50">
			<span
				...
				<?php printf(__('%d Campus Locations', 'chroma-early-start'), $locations_query->found_posts); ?>
			</span>
			...
			<p class="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed mb-12 fade-in-up">
				<?php _e('Explore our state-of-the-art campuses across Georgia. Each location features premium clinical environments, PrismaPath™ curriculum, and expert care.', 'chroma-early-start'); ?>
			</p>
			...
			<div
				...
				<div class="relative flex-grow">
					...
					<input type="text" id="location-search"
						placeholder="<?php esc_attr_e('Search by City or ZIP...', 'chroma-early-start'); ?>"
				...
				<div class="flex gap-2 p-1 overflow-x-auto no-scrollbar">
					<button onclick="filterLocations('all')" data-region="all"
						...
						<?php _e('All Locations', 'chroma-early-start'); ?>
					</button>
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10" id="locations-grid">
				...
				if ($locations_query->have_posts()):
					while ($locations_query->have_posts()):
						...
						$region_name = $region_term ? $region_term->name : __('Georgia', 'chroma-early-start');

						$is_new = get_post_meta($location_id, 'location_new', true);
						$badge_text = $is_new ? __('New Campus', 'chroma-early-start') : __('Now Enrolling', 'chroma-early-start');
						?>
								...
								<div class="p-10 flex-1 flex flex-col">
									...
									<div class="mt-auto flex items-center justify-between pt-8 border-t border-stone-50">
										<span class="text-stone-400 text-[10px] font-bold uppercase tracking-widest">
											<?php _e('Explore Campus', 'chroma-early-start'); ?>
										</span>
										<div
	...
	<section class="py-24 bg-stone-900 text-white relative overflow-hidden">
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
			<h2 class="text-4xl md:text-5xl font-bold mb-8">
				<?php _e('Not sure where to start?', 'chroma-early-start'); ?></h2>
			<p class="text-xl text-stone-400 max-w-2xl mx-auto mb-12">
				<?php _e('Our clinical intake team can help you identify the best campus and program for your child\'s unique developmental path.', 'chroma-early-start'); ?>
			</p>
			<div class="flex flex-wrap justify-center gap-6">
				...
				<a href="tel:4045550123"
					...
					<?php _e('Call Directly', 'chroma-early-start'); ?>
				</a>
			</div>
		</div>
	</section>
