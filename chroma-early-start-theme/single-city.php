            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="fade-in-up">
                    <span
                        ...
                        <?php printf(__('Serving %s & %s County', 'chroma-early-start'), esc_html($city), esc_html($county)); ?>
                    </span>
                    <h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight">
                        <?php printf(__('Top-Rated Clinical Care in <span class="text-rose-600">%s.</span>', 'chroma-early-start'), esc_html($city)); ?>
                    </h1>
                    <p class="text-xl text-stone-600 leading-relaxed mb-10 max-w-xl">
                        <?php printf(__('Are you looking for specialized pediatric therapy near you? Discover Chroma’s clinical excellence in the %s area, featuring the PrismaPath™ model.', 'chroma-early-start'), esc_html($city)); ?>
                    </p>
                    ...
                    <a href="#locations"
                        ...
                        <?php printf(__('View Clinics in %s', 'chroma-early-start'), esc_html($city)); ?>
                    </a>
                </div>
    ...
    <section class="py-24 bg-stone-50">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up">
            <h2 class="text-3xl font-bold text-stone-900 mb-8">
                <?php printf(__('About our %s Presence', 'chroma-early-start'), esc_html($city)); ?>
            </h2>
            <div class="text-xl text-stone-600 leading-relaxed prose prose-stone max-w-none">
                <?php if ($intro_text): ?>
                    <?php echo wp_kses_post(wpautop($intro_text)); ?>
                <?php else: ?>
                    <p><?php printf(__('Chroma ELA provides a haven for clinical growth in %s. Our dedicated team of therapists and educators work in harmony to provide intensive, evidence-based care in a nurturing environment.', 'chroma-early-start'), esc_html($city)); ?>
                    </p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 fade-in-up">
                <h2 class="text-4xl font-bold text-stone-900 mb-4">
                    <?php printf(__('Clinics Serving %s', 'chroma-early-start'), esc_html($city)); ?>
                </h2>
                <p class="text-stone-500 text-lg">
                    <?php _e('Select the campus closest to your home or work.', 'chroma-early-start'); ?>
                </p>
            </div>
                        ...
                        while ($loc_query->have_posts()):
                            ...
                            <div
                                ...
                                <a href="<?php the_permalink(); ?>"
                                    ...
                                    <?php _e('View Campus', 'chroma-early-start'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 fade-in-up">
                <h2 class="text-4xl font-bold mb-4">
                    <?php printf(__('Specialized Care for %s Families', 'chroma-early-start'), esc_html($city)); ?>
                </h2>
                <p class="text-stone-400 text-lg">
                    <?php _e('We offer a full spectrum of pediatric services tailored to individual needs.', 'chroma-early-start'); ?>
                </p>
            </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-stone-900 mb-12 text-center">
                <?php printf(__('Frequently Asked Questions in %s', 'chroma-early-start'), esc_html($city)); ?>
            </h2>
            <div class="space-y-4">
                <details
                    ...
                    <summary
                        ...
                        <span><?php printf(__('Are your %s clinics accepting new clients?', 'chroma-early-start'), esc_html($city)); ?></span>
                    ...
                    <div class="mt-4 text-stone-600 leading-relaxed text-sm">
                        <?php printf(__('Yes, our locations serving %s are currently accepting new families for ABA therapy, Occupational Therapy, and Speech Therapy. Contact our intake team to start the assessment process.', 'chroma-early-start'), esc_html($city)); ?>
                    </div>
                </details>
                ...
                <details
                    ...
                    <summary
                        class="flex items-center justify-between font-bold text-stone-900 list-none cursor-pointer">
                        <span><?php printf(__('Do you offer GA Pre-K in %s?', 'chroma-early-start'), esc_html($city)); ?></span>
                        <i data-lucide="chevron-down"
                            class="w-5 h-5 text-stone-400 group-open:rotate-180 transition-transform"></i>
                    </summary>
                    <div class="mt-4 text-stone-600 leading-relaxed text-sm">
                        <?php printf(__('Several of our campuses serving %s participate in the Georgia Lottery Pre-K program. Please check individual campus pages for specific availability.', 'chroma-early-start'), esc_html($city)); ?>
                    </div>
                </details>
            </div>
        </div>
