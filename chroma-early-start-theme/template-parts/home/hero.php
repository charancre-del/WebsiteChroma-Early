        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 fade-in-up">
                <div
                    ...
                    <span
                        class="text-rose-700 text-xs font-bold uppercase tracking-wider"><?php _e('Now Enrolling for 2026', 'chroma-early-start'); ?></span>
                </div>
                ...
                <div class="flex items-center space-x-6 pt-4">
                    ...
                    <div class="text-sm">
                        ...
                        <p class="text-stone-500 font-medium">
                            <?php _e('Trusted by 500+ Local Families', 'chroma-early-start'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div
                    ...
                    <img src="<?php echo esc_url($hero_image); ?>" class="w-full h-full object-cover no-lazy"
                        alt="<?php echo esc_attr__('Happy child in therapy', 'chroma-early-start'); ?>"
                ...
                <div
                    ...
                    <div>
                        <p class="text-stone-900 font-bold leading-none mb-1">
                            <?php _e('Clinic Center', 'chroma-early-start'); ?></p>
                        <p class="text-xs text-stone-500 font-medium tracking-wide uppercase">
                            <?php _e('Compassionate Care', 'chroma-early-start'); ?></p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        <p class="text-stone-900 font-bold leading-none mb-1">
                            <?php _e('ABA Experts', 'chroma-early-start'); ?></p>
                        <p class="text-xs text-stone-500 font-medium tracking-wide uppercase">
                            <?php _e('Evidence-Based', 'chroma-early-start'); ?></p>
                    </div>
                </div>
            </div>
        </div>
