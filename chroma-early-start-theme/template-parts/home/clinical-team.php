        ...
        <div class="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8">
            <div class="max-w-2xl fade-in-up">
                <span class="text-rose-600 font-bold uppercase tracking-[0.2em] text-xs mb-4 block">
                    <?php _e('Our Clinical Experts', 'chroma-early-start'); ?>
                </span>
                <h2 class="text-4xl lg:text-5xl font-extrabold text-stone-900 mb-6">
                    <?php _e('Expertise Guided by', 'chroma-early-start'); ?> <span class="italic text-rose-600">
                        <?php _e('Compassion', 'chroma-early-start'); ?>
                    </span>
                </h2>
                <p class="text-stone-600 text-lg leading-relaxed">
                    <?php _e('Our leadership team brings decades of experience in ABA, speech-language pathology, and pediatric development to every child\'s care plan.', 'chroma-early-start'); ?>
                </p>
            </div>
            <a href="<?php echo esc_url(home_url('/about-us/')); ?>"
                ...
                <?php _e('Meet the Full Team', 'chroma-early-start'); ?>
            </a>
        </div>
