...
<section id="faq" class="py-24 bg-white">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 fade-in-up">
            <span
                class="text-rose-600 font-bold uppercase tracking-[0.2em] text-xs mb-4 block"><?php echo esc_html($faq_data['subheading'] ?: __('Common Questions', 'chroma-early-start')); ?></span>
