...
$curriculum = earlystart_home_curriculum();
if (!$curriculum) {
    return;
}
?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            <h2 class="text-4xl md:text-5xl font-bold text-brand-ink mb-4">
                <?php echo esc_html($curriculum['heading'] ?: __('The Prismpath Curriculum', 'chroma-early-start')); ?>
            </h2>
        ...
        <?php if (!empty($curriculum['cta_link'])): ?>
            <div class="text-center">
                <a href="<?php echo esc_url($curriculum['cta_link']); ?>"
                    ...
                    <?php echo esc_html($curriculum['cta_label'] ?: __('Learn About Prismpath', 'chroma-early-start')); ?>
                </a>
            </div>
        <?php endif; ?>
