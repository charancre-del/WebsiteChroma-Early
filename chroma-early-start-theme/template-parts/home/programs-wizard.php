...
<section id="<?php echo esc_attr($program_slug); ?>" class="py-20 bg-brand-cream border-b border-chroma-blue/10"
    ...
    <div class="max-w-5xl mx-auto px-4 lg:px-6">
        ...
        <div class="text-center mb-10 fade-in-up">
            <h2 class="font-serif text-3xl md:text-4xl font-bold text-brand-ink mb-3"><?php _e('Find the right program in 10 seconds', 'chroma-early-start'); ?></h2>
            <p class="text-brand-ink text-sm md:text-base max-w-2xl mx-auto"><?php _e('Choose your child\'s age and we\'ll suggest the Chroma program designed for their development stage and your family\'s needs.', 'chroma-early-start'); ?></p>
        </div>
            ...
            <div class="hidden pt-6 opacity-0 translate-y-4 transition-all duration-500 ease-out"
                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="text-center md:text-left space-y-4 order-2 md:order-1">
                        ...
                        <div class="flex flex-wrap gap-3 text-xs pt-2 justify-center md:justify-start">
                            <a class="inline-flex items-center justify-center px-6 py-3 rounded-full border border-chroma-blue/20 bg-white text-brand-ink font-semibold hover:border-chroma-blue hover:text-chroma-blue transition shadow-sm"
                                ...
                                aria-label="<?php esc_attr_e('View all programs', 'chroma-early-start'); ?>">
                                <?php _e('View All Programs', 'chroma-early-start'); ?>
                            </a>
                            <a href="#tour"
                                ...
                                <?php _e('Speak to an enrollment specialist', 'chroma-early-start'); ?>
                            </a>
                    ...
                    <div
                        ...
                        <img src="" alt="<?php esc_attr_e('Program Preview', 'chroma-early-start'); ?>" class="w-full h-full object-cover"
                ...
                <div class="text-center mt-8 w-full">
                    <button type="button"
                        ...
                        <?php _e('Start Over', 'chroma-early-start'); ?>
                    </button>
                </div>
