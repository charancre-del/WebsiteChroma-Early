...
$tracks = earlystart_home_schedule_tracks();
...
<section id="schedule" class="py-20 bg-brand-cream relative" data-section="schedule">
	...
	<div class="max-w-6xl mx-auto px-4 lg:px-6" data-schedule
		...
		<div class="text-center mb-12">
			<span class="text-chroma-green font-bold tracking-[0.2em] text-xs uppercase mb-4 block"><?php _e('Day by Day', 'chroma-early-start'); ?></span>
			<h2 class="text-3xl md:text-4xl font-serif text-brand-ink mb-3"><?php _e('A Daily Rhythm of Joy', 'chroma-early-start'); ?></h2>
			<p class="text-brand-ink max-w-2xl mx-auto"><?php _e('We don\'t just fill time. Every classroom follows a thoughtful flow designed to balance stimulation, nourishment, and rest.', 'chroma-early-start'); ?></p>
		</div>
