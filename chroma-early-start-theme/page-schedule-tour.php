            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="fade-in-up">
                    <span
                        ...
                        <?php _e('Clinic Tours', 'chroma-early-start'); ?>
                    </span>
                    <h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight">
                        <?php _e('Experience our', 'chroma-early-start'); ?><br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-orange-500">
                            <?php _e('Clinical Magic.', 'chroma-early-start'); ?>
                        </span>
                    </h1>
                    <p class="text-xl text-stone-600 leading-relaxed mb-10 max-w-xl">
                        <?php _e('Select your preferred campus below to schedule a private walkthrough with our Clinical Director. We look forward to welcoming your family.', 'chroma-early-start'); ?>
                    </p>
                            ...
                            <div class="mt-auto pt-6 border-t border-stone-50">
                                <?php if ($post['booking']): ?>
                                    <a href="<?php echo esc_url($post['booking']); ?>" target="_blank"
                                        ...
                                        <?php _e('Schedule Tour', 'chroma-early-start'); ?>
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo esc_url($post['permalink']); ?>#contact"
                                        ...
                                        <?php _e('Inquire Now', 'chroma-early-start'); ?>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center fade-in-up">
            <h2 class="text-3xl font-bold text-stone-900 mb-8">
                <?php _e('What happens during a tour?', 'chroma-early-start'); ?></h2>
            <div class="grid md:grid-cols-3 gap-12 text-left">
                <div>
                    <div
                        ...
                        1</div>
                    <h4 class="font-bold text-stone-900 mb-2"><?php _e('Walkthrough', 'chroma-early-start'); ?></h4>
                    <p class="text-sm text-stone-500 leading-relaxed">
                        <?php _e('See our clean, safe, and stimulating clinical environments in person.', 'chroma-early-start'); ?>
                    </p>
                </div>
                <div>
                    <div
                        ...
                        2</div>
                    <h4 class="font-bold text-stone-900 mb-2"><?php _e('Meet the Team', 'chroma-early-start'); ?></h4>
                    <p class="text-sm text-stone-500 leading-relaxed">
                        <?php _e('Speak with the Clinical Director about your child’s unique goals.', 'chroma-early-start'); ?>
                    </p>
                </div>
                <div>
                    <div
                        ...
                        3</div>
                    <h4 class="font-bold text-stone-900 mb-2"><?php _e('Next Steps', 'chroma-early-start'); ?></h4>
                    <p class="text-sm text-stone-500 leading-relaxed">
                        <?php _e('Learn about our intake process, assessment, and individualized timelines.', 'chroma-early-start'); ?>
                    </p>
                </div>
            </div>
        </div>
