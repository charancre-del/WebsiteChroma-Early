    ...
    <section class="relative bg-white pt-24 pb-20 lg:pt-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <span
                ...
                <?php _e('Support & Clarity', 'chroma-early-start'); ?>
            </span>
            <h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight fade-in-up">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-500">
                    <?php _e('Help you today?', 'chroma-early-start'); ?>
                </span>
            </h1>
            <p class="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed fade-in-up">
                <?php _e('Find answers to common questions about our clinical model, enrollment process, and how we support your child\'s unique journey.', 'chroma-early-start'); ?>
            </p>
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            $faq_categories = array(
                array(
                    ...
                    'questions' => array(
                        array('q' => 'What is the "Chroma Standard" for ABA?', 'a' => 'We practice assent-based, play-led ABA. This means we prioritize the child\'s happiness and willingness to participate. We don\'t use forced compliance; we build skills through trust and meaningful reinforcement.'),
    ...
    <section class="py-24 bg-stone-900 text-white text-center relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10 fade-in-up">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">
                <?php _e('Still have questions?', 'chroma-early-start'); ?>
            </h2>
            <p class="text-stone-400 text-xl mb-10 leading-relaxed">
                <?php _e('Our admissions coordinators are happy to jump on a call and talk through your specific situation. We are here to help.', 'chroma-early-start'); ?>
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo esc_url(home_url('/contact/')); ?>"
                    ...
                    <?php _e('Message Admissions', 'chroma-early-start'); ?>
                </a>
                <a href="tel:5551234567"
                    ...
                    <?php _e('Call (555) 123-4567', 'chroma-early-start'); ?>
                </a>
            </div>
        </div>
    </section>
