...
function earlystart_contact_page_meta_boxes() {
	...
	add_meta_box(
		'chroma-contact-form',
		__( 'Form Settings', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Corporate Office Info', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Careers Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Press Inquiries Section', 'chroma-early-start' ),
