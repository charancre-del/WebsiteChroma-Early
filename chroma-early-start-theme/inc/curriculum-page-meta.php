...
function earlystart_curriculum_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Prismpath Framework (5 Pillars)', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Developmental Timeline', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Environment (Third Teacher)', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Measuring Milestones', 'chroma-early-start' ),
