 ...
 */
function earlystart_employers_page_meta_boxes() {
	add_meta_box(
		'chroma-employers-hero',
		__( 'Hero Section', 'chroma-early-start' ),
		'earlystart_employers_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		...
		__( 'Solutions Section (3 Cards)', 'chroma-early-start' ),
		'earlystart_employers_solutions_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Tax Incentives Section', 'chroma-early-start' ),
		'earlystart_employers_tax_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Contact Section', 'chroma-early-start' ),
		'earlystart_employers_contact_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'earlystart_employers_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function earlystart_employers_hero_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_employers_hero_meta', 'earlystart_employers_hero_nonce' );
 ...
 */
function earlystart_employers_solutions_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_employers_solutions_meta', 'earlystart_employers_solutions_nonce' );
 ...
 */
function earlystart_employers_tax_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_employers_tax_meta', 'earlystart_employers_tax_nonce' );
 ...
 */
function earlystart_employers_contact_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_employers_contact_meta', 'earlystart_employers_contact_nonce' );
 ...
 */
function earlystart_save_employers_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'earlystart_employers_hero_nonce' => array(
		...
		'earlystart_employers_solutions_nonce' => array(
		...
		'earlystart_employers_tax_nonce' => array(
		...
		'earlystart_employers_contact_nonce' => array(
...
add_action( 'save_post', 'earlystart_save_employers_page_meta' );

/**
 * Seed default values for Employers page when template is first applied
 */
function earlystart_seed_employers_page_defaults( $post_id ) {
	// Check if this is a page
	if ( get_post_type( $post_id ) !== 'page' ) {
		return;
	}
...
add_action( 'save_post', 'earlystart_seed_employers_page_defaults', 5 );
