...
function earlystart_parents_page_meta_boxes()
{
    ...
    add_meta_box(
        ...
        __('Quick Links / Resources', 'chroma-early-start'),
    ...
    add_meta_box(
        ...
        __('Events Section', 'chroma-early-start'),
    ...
    add_meta_box(
        ...
        __('Moments of Joy Gallery', 'chroma-early-start'),
    ...
    add_meta_box(
        ...
        __('Nutrition Section', 'chroma-early-start'),
    ...
    add_meta_box(
        ...
        __('Safety Section', 'chroma-early-start'),
    ...
    add_meta_box(
        'chroma-parents-faq',
        __('FAQ Section', 'chroma-early-start'),
    ...
    add_meta_box(
        ...
        __('Referral Banner', 'chroma-early-start'),
...
function earlystart_parents_gallery_meta_box_render($post)
{
    ...
    <table class="form-table">
        <tr>
            <th><label for="parents_moments_gallery"><?php _e('Image Gallery (URLs)', 'chroma-early-start'); ?></label>
            </th>
            <td>
                ...
                <p class="description">
                    <?php _e('Enter one image URL per line. These will be displayed in the carousel.', 'chroma-early-start'); ?>
                </p>
            </td>
        </tr>
    </table>
