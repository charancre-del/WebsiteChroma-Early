...
function earlystart_stories_page_meta_box() {
	add_meta_box(
		...
		__( 'Featured Post', 'chroma-early-start' ),
...
function earlystart_stories_featured_meta_box_render( $post ) {
	...
	?>
	<p>
		<label for="stories_featured_post"><?php _e( 'Select Featured Post', 'chroma-early-start' ); ?></label>
		<select id="stories_featured_post" name="stories_featured_post" class="widefat">
			<option value=""><?php _e( 'None', 'chroma-early-start' ); ?></option>
		...
		<small><?php _e( 'This post will be displayed as the large featured post at the top of the Stories page.', 'chroma-early-start' ); ?></small>
	</p>
	<?php
}
