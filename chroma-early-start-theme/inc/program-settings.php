...
function earlystart_program_settings_customize_register(WP_Customize_Manager $wp_customize)
{
	$wp_customize->add_section(
		...
		array(
			'title' => __('Programs', 'chroma-early-start'),
			'description' => __('Control the URL slug for the Program archive and permalinks.', 'chroma-early-start'),
			'priority' => 131,
		)
	);
	...
	$wp_customize->add_control(
		'earlystart_program_base_slug',
		array(
			'label' => __('Program base slug', 'chroma-early-start'),
			'description' => __('Used for the Programs archive URL and individual program permalinks.', 'chroma-early-start'),
