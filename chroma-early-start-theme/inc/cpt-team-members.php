...
{
    $labels = array(
        'name' => _x('Team Members', 'Post Type General Name', 'chroma-early-start'),
        'singular_name' => _x('Team Member', 'Post Type Singular Name', 'chroma-early-start'),
        'menu_name' => __('Team Members', 'chroma-early-start'),
        'all_items' => __('All Team Members', 'chroma-early-start'),
        'add_new_item' => __('Add New Team Member', 'chroma-early-start'),
        'edit_item' => __('Edit Team Member', 'chroma-early-start'),
        'view_item' => __('View Team Member', 'chroma-early-start'),
        'search_items' => __('Search Team Members', 'chroma-early-start'),
        'not_found' => __('No team members found', 'chroma-early-start'),
        'not_found_in_trash' => __('No team members found in Trash', 'chroma-early-start'),
    );

    $args = array(
        'label' => __('Team Member', 'chroma-early-start'),
        'labels' => $labels,
...
function earlystart_team_member_add_meta_box()
{
    add_meta_box(
        ...
        __('Team Member Details', 'chroma-early-start'),
...
function earlystart_team_member_render_meta_box($post)
{
    ...
    <p>
        <label for="team_member_title"
            style="font-weight:bold; display:block; margin-bottom:5px;"><?php _e('Job Title / Role', 'chroma-early-start'); ?></label>
        ...
        <span class="description"
            style="display:block; margin-top:5px;"><?php _e('e.g. "Executive Director" or "Lead Teacher"', 'chroma-early-start'); ?></span>
    </p>
    <?php
}
...
function earlystart_team_member_admin_columns($columns)
{
    ...
    $new_columns['title'] = __('Name', 'chroma-early-start');
    $new_columns['role'] = __('Title', 'chroma-early-start');
...
function earlystart_seed_default_team_members()
{
    ...
    $defaults = array(
        array(
            'post_title' => __('Jordan Avery', 'chroma-early-start'),
            'post_content' => __('Jordan leads the Prismpath team with a passion for creating joyful, evidence-based learning experiences for every child.', 'chroma-early-start'),
            'role' => __('Executive Director', 'chroma-early-start'),
        ),
        array(
            'post_title' => __('Samira Patel', 'chroma-early-start'),
            'post_content' => __('Samira partners with families and educators to ensure each center reflects the needs of its community.', 'chroma-early-start'),
            'role' => __('Director of Family Partnerships', 'chroma-early-start'),
        ),
        array(
            'post_title' => __('Luis Moreno', 'chroma-early-start'),
            'post_content' => __('Luis coaches classroom teams, championing playful curricula that meet students where they are.', 'chroma-early-start'),
            'role' => __('Director of Learning', 'chroma-early-start'),
        ),
    );
