...
function earlystart_careers_page_meta_boxes() {
	...
	add_meta_box(
		...
		__( 'Culture & Benefits Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Current Opportunities Section (3 Job Listings)', 'chroma-early-start' ),
	...
	add_meta_box(
		'chroma-careers-cta',
		__( 'Application CTA Section', 'chroma-early-start' ),
