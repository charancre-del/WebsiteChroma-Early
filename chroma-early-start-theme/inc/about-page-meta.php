...
function earlystart_about_page_meta_boxes() {
	add_meta_box(
		'chroma-about-hero',
		__( 'Hero Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Mission Section', 'chroma-early-start' ),
	...
	add_meta_box(
		'chroma-about-story',
		__( 'Story Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Educators Section', 'chroma-early-start' ),
	...
	add_meta_box(
		'chroma-about-values',
		__( 'Values (Chroma Standard) Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Leadership Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Nutrition & Wellness Section', 'chroma-early-start' ),
	...
	add_meta_box(
		...
		__( 'Philanthropy Section', 'chroma-early-start' ),
	...
	add_meta_box(
		'chroma-about-cta',
		__( 'CTA Section', 'chroma-early-start' ),
