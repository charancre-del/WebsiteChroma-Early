...
function earlystart_seo_customizer_settings($wp_customize) {
    ...
    $wp_customize->add_section('earlystart_seo_settings', [
        'title'       => __('SEO & Social', 'chroma-early-start'),
        'description' => __('Configure Twitter Cards, Open Graph, and other SEO settings.', 'chroma-early-start'),
        'priority'    => 35,
    ]);
    ...
    $wp_customize->add_control('earlystart_twitter_site', [
        'label'       => __('Twitter Site Handle', 'chroma-early-start'),
        'description' => __('Your Twitter/X handle (e.g., @chromaela or chromaela). Used for twitter:site meta tag.', 'chroma-early-start'),
    ...
    $wp_customize->add_control('earlystart_twitter_card_type', [
        'label'       => __('Twitter Card Type', 'chroma-early-start'),
        'description' => __('Choose how your links appear when shared on Twitter/X.', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
        'type'        => 'select',
        'choices'     => [
            'summary'             => __('Summary (small image)', 'chroma-early-start'),
            'summary_large_image' => __('Summary with Large Image', 'chroma-early-start'),
        ],
    ]);
    ...
    $wp_customize->add_control('earlystart_fb_app_id', [
        'label'       => __('Facebook App ID', 'chroma-early-start'),
        'description' => __('Optional. Used for Facebook Insights.', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
        'type'        => 'text',
        'input_attrs' => [
    ...
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'earlystart_default_og_image', [
        'label'       => __('Default Social Share Image', 'chroma-early-start'),
        'description' => __('Default image for social sharing when a post has no featured image. Recommended: 1200x630px.', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
    ]));
    ...
    $wp_customize->add_control('earlystart_facebook_url', [
        'label'       => __('Facebook Page URL', 'chroma-early-start'),
        'description' => __('Your Facebook page URL. Used in Organization schema sameAs.', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
        'type'        => 'url',
        'input_attrs' => [
    ...
    $wp_customize->add_control('earlystart_global_brand_phonetic', [
        'label'       => __('Brand Phonetic Name', 'chroma-early-start'),
        'description' => __('How your brand is pronounced (for voice search). E.g., "KROH-muh Early Learning"', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
        'type'        => 'text',
        'input_attrs' => [
    ...
    $wp_customize->add_control('earlystart_footer_seo_text', [
        'label'       => __('Footer SEO Text (NLP)', 'chroma-early-start'),
        'description' => __('Proximity-based footer copy for local SEO. Include city names and "near me" keywords.', 'chroma-early-start'),
        'section'     => 'earlystart_seo_settings',
        'type'        => 'textarea',
    ]);
}
