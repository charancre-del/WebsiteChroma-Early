...
while (have_posts()):
	...
	$hero_subtitle = earlystart_get_translated_meta($location_id, 'location_hero_subtitle') ?: __('Now Enrolling: Pre-K & Toddlers', 'chroma-early-start');
	...
	$tagline = earlystart_get_translated_meta($location_id, 'location_tagline') ?: sprintf(__("%s's home for brilliant beginnings.", 'chroma-early-start'), $city);
	...
	$hours = earlystart_get_translated_meta($location_id, 'location_hours') ?: __('7am - 6pm', 'chroma-early-start');
	$ages_served = earlystart_get_translated_meta($location_id, 'location_ages_served') ?: __('6w - 12y', 'chroma-early-start');
	...
	<main class="pt-20">
				...
				<div class="grid lg:grid-cols-2 gap-16 items-center">
					<div class="fade-in-up">
						<span
							...
							<?php echo esc_html($hero_subtitle ?: __('Clinical Excellence', 'chroma-early-start')); ?>
						</span>
						...
						<div class="grid grid-cols-3 gap-8 pt-10 border-t border-stone-100">
							<div>
								...
								<div class="text-[10px] font-bold text-stone-400 uppercase tracking-widest">
									<?php _e('Ages', 'chroma-early-start'); ?>
								</div>
							</div>
							<div>
					...
					<div class="relative fade-in-up delay-200 block">
						...
						<div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white aspect-square md:aspect-[4/3]"
							...
							$hero_review_author = earlystart_get_translated_meta(get_the_ID(), 'location_hero_review_author') ?: __('Parent Review', 'chroma-early-start');
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				<div class="text-center mb-20 fade-in-up">
					<h2 class="text-4xl font-bold text-stone-900 mb-6">
						<?php _e('Designed for Clinical Magic.', 'chroma-early-start'); ?>
					</h2>
					<p class="text-xl text-stone-500 max-w-2xl mx-auto">
						<?php printf(__('Every corner of our %s campus is intentional—from sensory-sensitive treatment rooms to stimulating learning environments.', 'chroma-early-start'), esc_html($city)); ?>
					</p>
				</div>
				...
				<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
					<div
						...
						<h3 class="text-xl font-bold text-stone-900 mb-4">
							<?php _e('Secure Access', 'chroma-early-start'); ?>
						</h3>
						<p class="text-stone-500 text-sm leading-relaxed">
							<?php _e('Biometric entry and constant clinical oversight ensure our students are safe and supported.', 'chroma-early-start'); ?>
						</p>
					</div>
					...
					<div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 fade-in-up"
						...
						<h3 class="text-xl font-bold text-stone-900 mb-4">
							<?php _e('Sensory Spaces', 'chroma-early-start'); ?>
						</h3>
						<p class="text-stone-500 text-sm leading-relaxed">
							<?php _e('Custom-built zones to help students regulate and focus through evidence-based sensory integration.', 'chroma-early-start'); ?>
						</p>
					</div>
					...
					<div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 fade-in-up"
						...
						<h3 class="text-xl font-bold text-stone-900 mb-4"><?php _e('STEM Labs', 'chroma-early-start'); ?>
						</h3>
						<p class="text-stone-500 text-sm leading-relaxed">
							<?php _e('Clinical learning hubs for early engineering, light exploration, and scientific discovery.', 'chroma-early-start'); ?>
						</p>
					</div>
					...
					<div class="bg-white p-10 rounded-[2.5rem] shadow-sm border border-stone-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 fade-in-up"
						...
						<h3 class="text-xl font-bold text-stone-900 mb-4"><?php _e('GA Pre-K', 'chroma-early-start'); ?>
						</h3>
						<p class="text-stone-500 text-sm leading-relaxed">
							<?php _e('A proud partner of the Georgia Pre-K Program, blending clinical support with academic readiness.', 'chroma-early-start'); ?>
						</p>
					</div>
				</div>
			</div>
					...
					<div class="grid lg:grid-cols-2 gap-20 items-center">
						...
						<div class="fade-in-up" <?php echo !$director_photo ? 'class="lg:col-span-2 text-center max-w-3xl mx-auto"' : ''; ?>>
							<span
								...
								<?php _e('Meet the Director', 'chroma-early-start'); ?>
							</span>
							<h2 class="text-4xl md:text-5xl font-bold mb-8 leading-tight">
								<?php echo $director_heading ?: sprintf(__('Leading with Heart in %s.', 'chroma-early-start'), esc_html($city)); ?>
							</h2>
							...
							<div class="flex items-center gap-6">
								...
								<div>
									...
									<p class="text-sm text-stone-500 uppercase tracking-widest">
										<?php _e('Campus Director', 'chroma-early-start'); ?></p>
								</div>
							</div>
						</div>
					</div>
			...
			<section id="virtual-tour" class="py-24 bg-white relative">
				<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
					<div class="text-center mb-16 fade-in-up">
						<h2 class="text-4xl font-bold text-stone-900 mb-6">
							<?php _e('Explore Our Clinical Environment.', 'chroma-early-start'); ?></h2>
						<p class="text-xl text-stone-500 max-w-2xl mx-auto">
							<?php printf(__('Walk through our %s campus from the comfort of your home. See our PrismaPath™ curriculum in action.', 'chroma-early-start'), esc_html($city)); ?>
						</p>
					</div>
					...
					<div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
						<div class="fade-in-up">
							<h2 class="text-4xl font-bold text-stone-900 mb-4">
								<?php _e('Specialized Care. Hyperlocal Delivery.', 'chroma-early-start'); ?></h2>
							<p class="text-stone-500 text-lg">
								<?php _e('Our campus offers clinical programs tailored to every developmental stage.', 'chroma-early-start'); ?>
							</p>
						</div>
						<a href="<?php echo esc_url(earlystart_get_program_archive_url()); ?>"
							...
							<?php _e('Explore Curriculum', 'chroma-early-start'); ?>
							...
							<a href="<?php the_permalink(); ?>"
								...
								<div class="p-10 flex-1 flex flex-col">
									...
									<div class="flex items-center gap-2 text-rose-600 font-bold text-xs">
										<?php _e('View Program', 'chroma-early-start'); ?>
		...
		<section class="py-24 bg-white">
			<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
				...
				<h2 class="text-4xl font-bold text-stone-900 mb-12">
					<?php _e('Voices of the Community.', 'chroma-early-start'); ?></h2>
				<blockquote class="text-3xl italic text-stone-600 leading-relaxed mb-12">
					"<?php echo esc_html($hero_review_text ?: __("The clinical support here has changed our child's trajectory. We finally feel heard and supported.", 'chroma-early-start')); ?>"
				</blockquote>
				<div class="flex flex-col items-center">
					<div class="w-16 h-1 bg-rose-600 rounded-full mb-6"></div>
					<cite class="not-italic">
						<span
							class="block text-lg font-bold text-stone-900 uppercase tracking-widest"><?php echo esc_html($hero_review_author ?: __("Happy Parent", 'chroma-early-start')); ?></span>
						<span
							class="text-sm text-stone-400"><?php _e('Georgia Campus Family', 'chroma-early-start'); ?></span>
					</cite>
				</div>
			</div>
		</section>
		...
		<section class="py-24 bg-stone-50 border-t border-stone-100">
			<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="text-center mb-16 fade-in-up">
					<h2 class="text-4xl font-bold text-stone-900 mb-6">
						<?php _e('Questions & Answers', 'chroma-early-start'); ?></h2>
					<p class="text-stone-500 text-lg">
						<?php _e('Common inquiries about our clinical approach and enrollment process.', 'chroma-early-start'); ?>
					</p>
				</div>
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				<div class="grid lg:grid-cols-2 gap-20 items-start">
					...
					<div class="fade-in-up">
						<span
							class="inline-block px-4 py-2 bg-rose-50 text-rose-600 rounded-full text-xs font-bold tracking-widest uppercase mb-6">
							<?php _e('Location Details', 'chroma-early-start'); ?>
						</span>
						<h2 class="text-4xl md:text-5xl font-bold text-stone-900 mb-8 leading-tight">
							<?php _e('Experience the Magic.', 'chroma-early-start'); ?>
						</h2>
						<p class="text-lg text-stone-500 mb-12 leading-relaxed">
							<?php _e('Clinical excellence is best experienced in person. Come see how we blend therapy and education in a premium environment.', 'chroma-early-start'); ?>
						</p>
						...
						<div class="space-y-10">
							<div class="flex gap-6 text-stone-900">
								...
								<div>
									<h4 class="text-lg font-bold mb-2"><?php _e('Campus Address', 'chroma-early-start'); ?>
									</h4>
							...
							<div class="flex gap-6 text-stone-900">
								...
								<div>
									<h4 class="text-lg font-bold mb-2"><?php _e('Direct Line', 'chroma-early-start'); ?>
									</h4>
							...
							<div class="flex gap-6 text-stone-900">
								...
								<div>
									<h4 class="text-lg font-bold mb-2">
										<?php _e('Operational Hours', 'chroma-early-start'); ?></h4>
									<p class="text-stone-500 leading-relaxed"><?php echo esc_html($hours); ?>
										(<?php _e('Mon-Fri', 'chroma-early-start'); ?>)</p>
								</div>
							</div>
						</div>
					...
					<div id="tour"
						...
						<h3 class="text-3xl font-bold text-stone-900 mb-4">
							<?php _e('Schedule a Private Tour', 'chroma-early-start'); ?></h3>
						<p class="text-stone-500 mb-10">
							<?php _e('Enter your details below and our intake team will coordinate a time for you to visit.', 'chroma-early-start'); ?>
						</p>
						...
						<?php if ($tour_booking_link): ?>
							<div class="mt-10 pt-10 border-t border-stone-100 text-center">
								<p class="text-stone-400 text-sm font-bold uppercase tracking-widest mb-6">
									<?php _e('Or Book Instantly', 'chroma-early-start'); ?></p>
								<a href="<?php echo esc_url($tour_booking_link); ?>"
									...
									<?php _e('Book Direct via Calendar', 'chroma-early-start'); ?>
								</a>
							</div>
						<?php endif; ?>
					</div>
...
<div id="chroma-tour-modal" class="fixed inset-0 z-[100] hidden" role="dialog" aria-modal="true">
	...
	<div
		...
		<div class="bg-stone-50 border-b border-stone-100 px-8 py-6 flex items-center justify-between flex-shrink-0">
			<h3 class="text-2xl font-bold text-stone-900"><?php _e('Schedule Your Visit', 'chroma-early-start'); ?></h3>
			<div class="flex items-center gap-6">
				<a href="#" id="chroma-tour-external" target="_blank"
					...
					<?php _e('Open in new tab', 'chroma-early-start'); ?> <i data-lucide="external-link"
