    ...
    <section class="relative bg-white pt-24 pb-20 lg:pt-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <span
                ...
                <?php _e('Clinical Leadership', 'chroma-early-start'); ?>
            </span>
            <h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight fade-in-up">
                <?php _e('The Heart of', 'chroma-early-start'); ?><br>
            ...
            <p class="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed fade-in-up">
                <?php _e('We don\'t just hire technicians; we hire career clinicians. Our team is selected for their passion, patience, and professional credentials.', 'chroma-early-start'); ?>
            </p>
        </div>
    </section>
                ...
                <?php else: ?>
                    <div class="col-span-full text-center py-20">
                        <p class="text-stone-500">
                            <?php _e('No team members found.', 'chroma-early-start'); ?>
                        </p>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center mb-16 fade-in-up">
                <h2 class="text-4xl font-bold mb-4">
                    <?php _e('Our Non-Negotiables', 'chroma-early-start'); ?>
                </h2>
                <p class="text-rose-100 max-w-2xl mx-auto text-lg">
                    <?php _e('Four core pillars guide every clinical decision we make.', 'chroma-early-start'); ?>
                </p>
            </div>
    ...
    <section class="py-24 bg-white text-center">
        <div class="max-w-4xl mx-auto px-4 fade-in-up">
            <h2 class="text-4xl font-bold text-stone-900 mb-6">
                <?php _e('Want to join the mission?', 'chroma-early-start'); ?>
            </h2>
            <p class="text-xl text-stone-600 mb-10 leading-relaxed">
                <?php _e('We are always looking for passionate BCBAs, RBTs, and Speech Therapists to join our growing network.', 'chroma-early-start'); ?>
            </p>
            <a href="<?php echo esc_url(home_url('/careers/')); ?>"
                ...
                <?php _e('Explore Careers', 'chroma-early-start'); ?>
