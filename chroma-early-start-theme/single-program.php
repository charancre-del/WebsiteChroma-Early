...
while (have_posts()):
	...
	// Prismpath section
	$prism_title = get_post_meta($program_id, 'program_prism_title', true) ?: __('Clinical & Developmental Focus', 'chroma-early-start');
	...
	// Schedule
	$schedule_title = get_post_meta($program_id, 'program_schedule_title', true) ?: __('A Typical Therapeutic Day', 'chroma-early-start');
					...
					<div class="fade-in-up">
						<div
							...
							<span
								...
								<?php echo esc_html($age_range ?: __('Pediatric Program', 'chroma-early-start')); ?>
							</span>
						</div>
						...
						<div class="flex flex-wrap gap-4">
							<a href="<?php echo esc_url(home_url('/locations/')); ?>"
								...
								<?php _e('Find a Clinic', 'chroma-early-start'); ?>
							</a>
							<?php if ($lesson_plan_url): ?>
								<a href="<?php echo esc_url($lesson_plan_url); ?>" target="_blank"
									...
									<?php _e('View Curriculum PDF', 'chroma-early-start'); ?>
								</a>
							<?php endif; ?>
						</div>
					</div>
				...
				<div class="grid lg:grid-cols-2 gap-20 items-center">
					...
					<div class="fade-in-up order-1 lg:order-2">
						<span
							...
							<?php _e('The PrismaPath™ Focus', 'chroma-early-start'); ?>
						</span>
				...
				<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
					<div class="text-center mb-20 fade-in-up">
						...
						<p class="text-stone-500 text-lg">
							<?php _e('Structured routines facilitate confidence, while spontaneous play builds skills.', 'chroma-early-start'); ?>
						</p>
					</div>
				...
				<div class="grid lg:grid-cols-2 gap-20">
					<div class="fade-in-up">
						<h2 class="text-3xl font-bold text-stone-900 mb-10">
							<?php _e('Common Questions', 'chroma-early-start'); ?>
						</h2>
						<div class="space-y-4">
							<?php
					...
					<div class="fade-in-up">
						<div class="bg-stone-900 rounded-[3rem] p-12 text-white relative overflow-hidden">
							...
							<h2 class="text-3xl font-bold mb-8"><?php _e('Ready to Start?', 'chroma-early-start'); ?></h2>
							<div class="space-y-8 mb-10">
								<div class="flex gap-6">
									<div
										...
										1</div>
									<div>
										<h4 class="font-bold mb-1"><?php _e('Find Your Clinic', 'chroma-early-start'); ?>
										</h4>
										<p class="text-xs text-stone-400">
											<?php _e('Select a location near you with availability.', 'chroma-early-start'); ?>
										</p>
									</div>
								</div>
								<div class="flex gap-6">
									<div
										...
										2</div>
									<div>
										<h4 class="font-bold mb-1"><?php _e('Clinical Tour', 'chroma-early-start'); ?></h4>
										<p class="text-xs text-stone-400">
											<?php _e('Tour our facilities and meet our clinical team.', 'chroma-early-start'); ?>
										</p>
									</div>
								</div>
								<div class="flex gap-6">
									<div
										...
										3</div>
									<div>
										<h4 class="font-bold mb-1"><?php _e('Assessment & Start', 'chroma-early-start'); ?>
										</h4>
										<p class="text-xs text-stone-400">
											<?php _e('We build your child’s individualized clinical roadmap.', 'chroma-early-start'); ?>
										</p>
									</div>
								</div>
							</div>
							<a href="<?php echo esc_url(home_url('/locations/')); ?>"
								...
								<?php _e('Book Your Clinical Tour', 'chroma-early-start'); ?>
							</a>
						</div>
					</div>
				</div>
