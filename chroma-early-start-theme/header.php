...
<body <?php body_class('bg-stone-50 text-stone-800 antialiased selection:bg-rose-100 selection:text-rose-900 font-sans flex flex-col min-h-screen'); ?>>
	...
	<!-- SITE HEADER WRAPPER -->
	<div id="site-header-fixed-group" class="fixed top-0 w-full z-[100] bg-white">
		...
		<!-- NAVIGATION -->
		<header class="w-full bg-white/95 backdrop-blur-xl shadow-sm border-b border-stone-100 relative z-[100]">
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div class="flex justify-between items-center h-20">
					...
					<!-- Mobile Menu Button -->
					<div class="xl:hidden flex-shrink-0 ml-4">
						<button data-mobile-nav-toggle
							class="text-stone-600 hover:text-rose-600 p-2 focus:outline-none">
			...
			<div data-mobile-nav
				class="absolute top-full left-0 w-full bg-white border-t border-stone-100 shadow-xl p-4 hidden flex-col space-y-4 xl:hidden h-screen overflow-y-auto pb-32">
