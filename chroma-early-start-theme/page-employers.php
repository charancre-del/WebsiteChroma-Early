...
$tax_description = earlystart_get_translated_meta($page_id, 'employers_tax_description') ?: __('Partnering with Chroma isn\'t just an investment in your company culture—it\'s a smart financial move. State and Federal programs significantly offset the cost of providing childcare benefits.', 'chroma-early-start');
