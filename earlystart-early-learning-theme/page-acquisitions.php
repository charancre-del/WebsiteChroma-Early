        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-brand-ink mb-4">
                    <?php _e('Start the Conversation', 'earlystart-early-learning'); ?>
                </h2>
                <p class="text-xl text-brand-ink/90">
                    <?php _e('Fill out the form below and our acquisitions team will be in touch.', 'earlystart-early-learning'); ?>
                </p>
            </div>
    ...
    if ($process_steps):
        ...
        <section class="py-16 bg-brand-cream">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-brand-ink mb-10 text-center">
                    <?php _e('Our Process', 'earlystart-early-learning'); ?>
                </h2>
                <div class="space-y-6">
