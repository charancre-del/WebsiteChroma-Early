            ...
            <div class="space-y-4">
                <details
                    ...
                    <div class="mt-4 text-stone-700 leading-relaxed text-sm">
                        <?php printf(__('Yes, our locations serving %s are currently accepting new families for autism assessment, behavioral assessment, ADHD assessment, OT assessment, ABA therapy, occupational therapy, and speech therapy. Contact our intake team to start the assessment process.', 'earlystart-early-learning'), esc_html($city)); ?>
                    </div>
                </details>
