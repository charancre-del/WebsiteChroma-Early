...
while (have_posts()):
	...
	$default_routes = array(
		array('icon' => 'baby', 'title' => 'For Families', 'desc' => 'Find a clinic near you and schedule a tour for autism diagnosis, ABA, behavioral health, speech, or OT.', 'link' => earlystart_get_page_link('locations'), 'label' => 'Find a Clinic', 'color' => 'rose'),
