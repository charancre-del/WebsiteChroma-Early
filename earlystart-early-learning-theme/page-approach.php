                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div class="fade-in-up">
                        ...
                        <h1 class="text-5xl md:text-7xl font-bold text-stone-900 mb-8 leading-tight">
                            <?php _e('Building Trust,', 'earlystart-early-learning'); ?><br>
                        ...
                        <div class="flex flex-wrap gap-4">
                            <a href="#model"
                                ...
                                <?php _e('Explore the Model', 'earlystart-early-learning'); ?>
                            </a>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-12">
                    ...
                    <div
                        ...
                        <p class="text-stone-700 leading-relaxed">
                            <?php _e('Diagnosis, ABA, behavioral health, speech, and OT goals are synchronized in one clinical roadmap. No conflicting adviceâ€”just one unified team.', 'earlystart-early-learning'); ?>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    <div class="bg-stone-50 p-10 rounded-[2rem] border border-stone-100 fade-in-up">
                        ...
                        <ul class="space-y-4 text-stone-700">
                            ...
                            <li class="flex items-start"><i data-lucide="x-circle"
                                    class="w-5 h-5 mr-3 text-stone-300 shrink-0 mt-0.5"></i>
                                <?php _e('Rigid desk-based learning environments.', 'earlystart-early-learning'); ?>
                            </li>
                            <li class="flex items-start"><i data-lucide="x-circle"
                                    class="w-5 h-5 mr-3 text-stone-300 shrink-0 mt-0.5"></i>
                                <?php _e('Ignoring "problem behaviors" during tasks.', 'earlystart-early-learning'); ?>
                            </li>
                            <li class="flex items-start"><i data-lucide="x-circle"
                                    class="w-5 h-5 mr-3 text-stone-300 shrink-0 mt-0.5"></i>
                                <?php _e('Siloed therapy with little collaboration.', 'earlystart-early-learning'); ?>
                            </li>
                        </ul>
                    </div>
                    <div class="bg-rose-50 p-10 rounded-[2rem] border border-rose-100 fade-in-up">
                        ...
                        <ul class="space-y-4 text-stone-700">
                            <li class="flex items-start"><i data-lucide="check-circle-2"
                                ...
                                <?php _e('Assent is required; joy is the metric.', 'earlystart-early-learning'); ?>
                            </li>
                            <li class="flex items-start"><i data-lucide="check-circle-2"
                                    class="w-5 h-5 mr-3 text-rose-500 shrink-0 mt-0.5"></i>
                                <?php _e('Naturalistic, play-led environments.', 'earlystart-early-learning'); ?>
                            </li>
                            <li class="flex items-start"><i data-lucide="check-circle-2"
                                    class="w-5 h-5 mr-3 text-rose-500 shrink-0 mt-0.5"></i>
                                <?php _e('Behaviors are treated as communication.', 'earlystart-early-learning'); ?>
                            </li>
                            <li class="flex items-start"><i data-lucide="check-circle-2"
                                    class="w-5 h-5 mr-3 text-rose-500 shrink-0 mt-0.5"></i>
                                <?php _e('Unified roadmaps across all specialties.', 'earlystart-early-learning'); ?>
                            </li>
                        </ul>
                    </div>
                </div>
