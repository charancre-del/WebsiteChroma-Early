...
foreach ($city_map as $city_name => $schools) {
    ...
    $page_title = "Pediatric Therapy in $city_name, GA | Chroma Early Start";
    ...
    update_post_meta($post_id, '_yoast_wpseo_metadesc', "Looking for pediatric therapy in $city_name? Chroma Early Start offers autism assessment, behavioral assessment, ADHD assessment, OT assessment, ABA therapy, speech therapy, and occupational therapy through convenient regional clinics.");
