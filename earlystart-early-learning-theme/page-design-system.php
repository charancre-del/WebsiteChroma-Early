...
<main class="pt-24 pb-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Typography -->
        <section class="mb-24">
            <h2 class="text-sm font-bold uppercase tracking-widest text-stone-300 mb-8 border-b border-stone-100 pb-2">
                Typography</h2>
            <div class="space-y-8">
                <div>
                    <span class="text-xs text-stone-300 block mb-2">Display 7XL / Bold</span>
                    <h1 class="text-7xl font-bold text-stone-900">Clinical Excellence</h1>
                </div>
                <div>
                    <span class="text-xs text-stone-300 block mb-2">Display 5XL / Bold</span>
                    <h2 class="text-5xl font-bold text-stone-900">Where Therapy Meets Play</h2>
                </div>
                <div>
                    <span class="text-xs text-stone-300 block mb-2">Heading 3XL / Bold</span>
                ...
                <div>
                    <span class="text-xs text-stone-300 block mb-2">Body Base / Regular</span>
                    <p class="text-base text-stone-700 max-w-3xl">Applied Behavior Analysis (ABA) is a therapy based on
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Brand Primary</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Interactive</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Backgrounds</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Subtle Wash</span>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Headings</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Body Text</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Borders</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Surface</span>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Gradient Start</span>
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="text-stone-700">Sparkles</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="grid md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4 items-center">
                        ...
                        <a href="#" class="text-rose-700 font-bold hover:underline">
                            Text Link &rarr;
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <span
                            class="text-[10px] bg-white border border-stone-200 px-3 py-1 rounded-full text-stone-700 font-bold uppercase tracking-wider">
                            North Atlanta
                        </span>
                    </div>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        ...
                        <div
                            ...
                            <div
                                class="w-12 h-12 bg-rose-50 rounded-2xl flex items-center justify-center mb-6 text-rose-700">
                                <i data-lucide="star" class="w-6 h-6"></i>
                            </div>
                            <h4 class="font-bold text-xl mb-3">Service Card</h4>
                            <p class="text-sm text-stone-700 leading-relaxed">Standard card used for features, services,
                        ...
                        <div class="bg-stone-50 p-8 rounded-[2.5rem] border border-stone-100">
                            ...
                            <p class="text-sm text-stone-700 leading-relaxed mb-6">Slightly darker background to break
                                up white space.</p>
                            <a href="#"
                                class="text-rose-700 font-bold text-sm uppercase tracking-widest flex items-center gap-2">
