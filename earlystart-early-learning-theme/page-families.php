    ...
    <div class="bg-stone-50 min-h-screen">
                    ...
                    <div class="relative mt-12 lg:mt-0 fade-in-up">
                        <div class="bg-rose-50 rounded-[2.5rem] p-10 border border-rose-100">
                            <h3 class="text-xl font-bold text-stone-900 mb-6">
                                <?php _e('The Benefits of Starting Early', 'earlystart-early-learning'); ?>
                            </h3>
                            <ul class="space-y-4">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-sm text-stone-300">
                                    <span class="flex items-center"><i data-lucide="check"
                                        ...
                                        <?php _e('No Auth Wait Times', 'earlystart-early-learning'); ?></span>
                                    <span class="flex items-center"><i data-lucide="check"
                                            class="w-4 h-4 text-green-400 mr-2"></i>
                                        <?php _e('FSA / HSA Accepted', 'earlystart-early-learning'); ?></span>
                                    <span class="flex items-center"><i data-lucide="check"
                                            class="w-4 h-4 text-green-400 mr-2"></i>
                    ...
                    <div class="relative fade-in-up">
                        ...
                        <div class="relative flex items-center mb-16 group">
                            ...
                            <div class="ml-20 md:ml-0 md:w-1/2 md:pl-12 text-left">
                                <span
                                    class="text-xs font-bold text-orange-500 uppercase tracking-wide"><?php _e('Step 2', 'earlystart-early-learning'); ?></span>
                        ...
                        <div class="relative flex items-center mb-16 md:flex-row-reverse group">
                            ...
                            <div class="ml-20 md:ml-0 md:w-1/2 md:pr-12 md:text-right">
                                <span
                                    class="text-xs font-bold text-amber-500 uppercase tracking-wide"><?php _e('Step 3', 'earlystart-early-learning'); ?></span>
                                <h4 class="text-xl font-bold text-stone-900">
                        ...
                        <div class="relative flex items-center group">
                            ...
                            <div class="ml-20 md:ml-0 md:w-1/2 md:pl-12 text-left">
                                <span
                                    class="text-xs font-bold text-green-500 uppercase tracking-wide"><?php _e('Step 4', 'earlystart-early-learning'); ?></span>
                                <h4 class="text-xl font-bold text-stone-900">
        ...
        <section class="py-24 bg-stone-900 text-white relative overflow-hidden">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="text-center mb-16 fade-in-up">
                    <span
                        class="text-rose-400 font-bold tracking-widest text-sm uppercase mb-4 block"><?php _e('The First Month', 'earlystart-early-learning'); ?></span>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16 fade-in-up">
                    <div class="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20">
                        <div
                            ...
                            W1</div>
                        <h3 class="text-xl font-bold mb-3"><?php _e('Pairing & Fun', 'earlystart-early-learning'); ?></h3>
                        <p class="text-stone-300 text-sm leading-relaxed">
                            <?php _e('Zero demands. Our only goal is for your child to fall in love with their therapist and the center. We play, we explore, and we build trust. This foundation is critical for future learning.', 'earlystart-early-learning'); ?>
                        </p>
                    </div>
                    <div class="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20">
                        <div
                    ...
                    <div class="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20">
                        <div
                            ...
                            W4</div>
                        <h3 class="text-xl font-bold mb-3"><?php _e('Initial Goals', 'earlystart-early-learning'); ?></h3>
                        <p class="text-stone-300 text-sm leading-relaxed">
                            <?php _e('We introduce the first few learning targets. You\'ll receive your first data update and have a check-in with your BCBA to review early progress and adjust the plan if needed.', 'earlystart-early-learning'); ?>
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-white/5 backdrop-blur-sm rounded-[2rem] p-8 md:p-12 border border-white/10 fade-in-up">
                    <h3 class="text-2xl font-bold mb-8 text-center text-white"><i data-lucide="backpack"
                        ...
                        <?php _e('What to Bring on Day One', 'earlystart-early-learning'); ?></h3>
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Change of Clothes', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Diapers/Wipes (if applicable)', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Nut-Free Lunch/Snacks', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Water Bottle', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Comfort Item (Lovey/Toy)', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Communication Device (if applicable)', 'earlystart-early-learning'); ?>
                        </div>
                        <div class="flex items-center text-stone-300">
                            <i data-lucide="check-square" class="w-5 h-5 text-green-400 mr-3"></i>
                            <?php _e('Indoor Shoes/Socks', 'earlystart-early-learning'); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                    <div class="fade-in-up">
                        ...
                        <h4 class="font-bold text-stone-900 mb-4">
                            <?php _e('Popular Workshop Topics:', 'earlystart-early-learning'); ?>
                        </h4>
                        <div class="space-y-3">
                            <div class="flex items-center p-3 bg-white rounded-lg shadow-sm">
                                <span class="w-2 h-2 bg-rose-500 rounded-full mr-3"></span>
                                <span
                                    class="text-stone-700"><?php _e('"Sleep Hygiene: Strategies for Bedtime"', 'earlystart-early-learning'); ?></span>
                            </div>
                            <div class="flex items-center p-3 bg-white rounded-lg shadow-sm">
                                <span class="w-2 h-2 bg-orange-500 rounded-full mr-3"></span>
                                <span
                                    class="text-stone-700"><?php _e('"Picky Eating & Feeding"', 'earlystart-early-learning'); ?></span>
                            </div>
                            <div class="flex items-center p-3 bg-white rounded-lg shadow-sm">
                                <span class="w-2 h-2 bg-amber-500 rounded-full mr-3"></span>
                                <span
                                    class="text-stone-700"><?php _e('"Sibling Interaction & Play"', 'earlystart-early-learning'); ?></span>
                            </div>
                            <div class="flex items-center p-3 bg-white rounded-lg shadow-sm">
                                <span class="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                                <span
                                    class="text-stone-700"><?php _e('"Toilet Training with Confidence"', 'earlystart-early-learning'); ?></span>
                            </div>
                        </div>
                    </div>
                    <div class="relative fade-in-up">
        ...
        <section class="py-24 bg-white border-t border-stone-100">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-3xl font-bold text-stone-900 mb-10 text-center">
                    <?php _e('Family Logistics FAQ', 'earlystart-early-learning'); ?>
                </h2>
