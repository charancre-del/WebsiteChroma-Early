...
<section id="care-model" class="py-20 bg-brand-cream border-y border-chroma-blue/10" data-section="care-model">
        <div class="max-w-6xl mx-auto px-4 lg:px-6 grid lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-5">
                        ...
                        <p class="text-brand-ink text-sm md:text-base"><?php _e('Our framework balances assessment, OT assessment, ABA, speech, OT, emotional regulation, social participation, and daily living goals so support matches each child\'s needs.', 'earlystart-early-learning'); ?></p>
