...
$programs = earlystart_home_programs_preview();
if (!$programs) {
    return;
}
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl md:text-5xl font-bold text-brand-ink mb-4">
                <?php echo esc_html($programs['heading'] ?: __('Our Programs', 'earlystart-early-learning')); ?>
            </h2>
        ...
        <?php if (!empty($programs['cta_link'])): ?>
            <div class="text-center">
                <a href="<?php echo esc_url($programs['cta_link']); ?>"
                    ...
                    <?php echo esc_html($programs['cta_label'] ?: __('View All Programs', 'earlystart-early-learning')); ?>
                </a>
            </div>
        <?php endif; ?>
