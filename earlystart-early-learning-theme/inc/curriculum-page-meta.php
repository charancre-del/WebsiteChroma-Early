 ...
 */
function earlystart_curriculum_page_meta_boxes() {
	add_meta_box(
		'chroma-curriculum-hero',
		__( 'Hero Section', 'earlystart-early-learning' ),
		'earlystart_curriculum_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		...
		__( 'Prismpath Framework (5 Pillars)', 'earlystart-early-learning' ),
		'earlystart_curriculum_framework_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Developmental Timeline', 'earlystart-early-learning' ),
		'earlystart_curriculum_timeline_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Environment (Third Teacher)', 'earlystart-early-learning' ),
		'earlystart_curriculum_environment_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Measuring Milestones', 'earlystart-early-learning' ),
		'earlystart_curriculum_milestones_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		'earlystart_curriculum_cta_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'earlystart_curriculum_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function earlystart_curriculum_hero_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_hero_meta', 'earlystart_curriculum_hero_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="curriculum_hero_badge" name="curriculum_hero_badge"
					   ...
					   class="large-text" placeholder="e.g., The Early Start Difference" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_hero_badge" name="_earlystart_es_curriculum_hero_badge"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_hero_badge', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_hero_title" name="_earlystart_es_curriculum_hero_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_hero_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_hero_description" name="_earlystart_es_curriculum_hero_description"
						  rows="4" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_curriculum_hero_description', true ) ); ?></textarea>
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function earlystart_curriculum_framework_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_framework_meta', 'earlystart_curriculum_framework_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_framework_title" name="_earlystart_es_curriculum_framework_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_framework_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_framework_description" name="_earlystart_es_curriculum_framework_description"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_curriculum_framework_description', true ) ); ?></textarea>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_pillar_<?php echo esc_attr( $pillar['name'] ); ?>_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_pillar_<?php echo esc_attr( $pillar['name'] ); ?>_title"
					   name="_earlystart_es_curriculum_pillar_<?php echo esc_attr( $pillar['name'] ); ?>_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_pillar_{$pillar['name']}_title", true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_pillar_<?php echo esc_attr( $pillar['name'] ); ?>_desc"
						  name="_earlystart_es_curriculum_pillar_<?php echo esc_attr( $pillar['name'] ); ?>_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, "_earlystart_es_curriculum_pillar_{$pillar['name']}_desc", true ) ); ?></textarea>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
 ...
 */
function earlystart_curriculum_timeline_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_timeline_meta', 'earlystart_curriculum_timeline_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_timeline_badge" name="_earlystart_es_curriculum_timeline_badge"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_timeline_badge', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_timeline_title" name="_earlystart_es_curriculum_timeline_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_timeline_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_timeline_description" name="_earlystart_es_curriculum_timeline_description"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_curriculum_timeline_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_title"
					   name="_earlystart_es_curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_stage_{$stage['name']}_title", true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<textarea id="curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_desc"
						  ...
						  rows="2" class="large-text"><?php echo esc_textarea( $desc ); ?></textarea>
				<br>
				<textarea id="_earlystart_es_curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_desc"
						  name="_earlystart_es_curriculum_stage_<?php echo esc_attr( $stage['name'] ); ?>_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, "_earlystart_es_curriculum_stage_{$stage['name']}_desc", true ) ); ?></textarea>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
 ...
 */
function earlystart_curriculum_environment_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_environment_meta', 'earlystart_curriculum_environment_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_env_badge" name="_earlystart_es_curriculum_env_badge"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_env_badge', true ) ); ?>"
					   placeholder="[ES] Badge" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_env_description" name="_earlystart_es_curriculum_env_description"
						  rows="4" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_curriculum_env_description', true ) ); ?></textarea>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_title"
					   name="_earlystart_es_curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_zone_{$zone['name']}_title", true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				<textarea id="curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_desc"
						  ...
						  rows="2" class="large-text"><?php echo esc_textarea( $desc ); ?></textarea>
				<br>
				<textarea id="_earlystart_es_curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_desc"
						  name="_earlystart_es_curriculum_zone_<?php echo esc_attr( $zone['name'] ); ?>_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, "_earlystart_es_curriculum_zone_{$zone['name']}_desc", true ) ); ?></textarea>
			</td>
		</tr>
		<?php endforeach; ?>
	</table>
 ...
 */
function earlystart_curriculum_milestones_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_milestones_meta', 'earlystart_curriculum_milestones_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_milestones_title" name="_earlystart_es_curriculum_milestones_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_milestones_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_curriculum_milestones_subtitle" name="_earlystart_es_curriculum_milestones_subtitle"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_milestones_subtitle', true ) ); ?>"
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_title"
					   name="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_milestone_{$card['name']}_title", true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_desc"
						  name="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_desc"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, "_earlystart_es_curriculum_milestone_{$card['name']}_desc", true ) ); ?></textarea>
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet1"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet1"
					   name="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet1"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_milestone_{$card['name']}_bullet1", true ) ); ?>"
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet2"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet2"
					   name="_earlystart_es_curriculum_milestone_<?php echo esc_attr( $card['name'] ); ?>_bullet2"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, "_earlystart_es_curriculum_milestone_{$card['name']}_bullet2", true ) ); ?>"
 ...
 */
function earlystart_curriculum_cta_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_curriculum_cta_meta', 'earlystart_curriculum_cta_nonce' );
		...
		<tr>
			...
			<td>
				<input type="text" id="curriculum_cta_title" name="curriculum_cta_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_curriculum_cta_title" name="_earlystart_es_curriculum_cta_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_curriculum_cta_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_curriculum_cta_description" name="_earlystart_es_curriculum_cta_description"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_curriculum_cta_description', true ) ); ?></textarea>
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function earlystart_save_curriculum_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'earlystart_curriculum_hero_nonce' => array(
			'curriculum_hero_badge'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_hero_badge'       => 'sanitize_text_field',
			'curriculum_hero_title'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_hero_title'       => 'sanitize_text_field',
			'curriculum_hero_description' => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_hero_description' => 'sanitize_textarea_field',
		),
		'earlystart_curriculum_framework_nonce' => array(
			'curriculum_framework_title'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_framework_title'       => 'sanitize_text_field',
			'curriculum_framework_description' => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_framework_description' => 'sanitize_textarea_field',
			'curriculum_pillar_physical_icon'  => 'sanitize_text_field',
			'curriculum_pillar_physical_title' => 'sanitize_text_field',
			'_earlystart_es_curriculum_pillar_physical_title' => 'sanitize_text_field',
			'curriculum_pillar_physical_desc'  => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_pillar_physical_desc'  => 'sanitize_textarea_field',
			'curriculum_pillar_emotional_icon' => 'sanitize_text_field',
			'curriculum_pillar_emotional_title'=> 'sanitize_text_field',
			'_earlystart_es_curriculum_pillar_emotional_title'=> 'sanitize_text_field',
			'curriculum_pillar_emotional_desc' => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_pillar_emotional_desc' => 'sanitize_textarea_field',
			'curriculum_pillar_social_icon'    => 'sanitize_text_field',
			'curriculum_pillar_social_title'   => 'sanitize_text_field',
			'_earlystart_es_curriculum_pillar_social_title'   => 'sanitize_text_field',
			'curriculum_pillar_social_desc'    => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_pillar_social_desc'    => 'sanitize_textarea_field',
			'curriculum_pillar_academic_icon'  => 'sanitize_text_field',
			'curriculum_pillar_academic_title' => 'sanitize_text_field',
			'_earlystart_es_curriculum_pillar_academic_title' => 'sanitize_text_field',
			'curriculum_pillar_academic_desc'  => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_pillar_academic_desc'  => 'sanitize_textarea_field',
			'curriculum_pillar_creative_icon'  => 'sanitize_text_field',
			'curriculum_pillar_creative_title' => 'sanitize_text_field',
			'_earlystart_es_curriculum_pillar_creative_title' => 'sanitize_text_field',
			'curriculum_pillar_creative_desc'  => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_pillar_creative_desc'  => 'sanitize_textarea_field',
		),
		'earlystart_curriculum_timeline_nonce' => array(
			'curriculum_timeline_badge'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_timeline_badge'       => 'sanitize_text_field',
			'curriculum_timeline_title'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_timeline_title'       => 'sanitize_text_field',
			'curriculum_timeline_description' => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_timeline_description' => 'sanitize_textarea_field',
			'curriculum_timeline_image'       => 'esc_url_raw',
			'curriculum_stage_foundation_title' => 'sanitize_text_field',
			'_earlystart_es_curriculum_stage_foundation_title' => 'sanitize_text_field',
			'curriculum_stage_foundation_desc'  => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_stage_foundation_desc'  => 'sanitize_textarea_field',
			'curriculum_stage_discovery_title'  => 'sanitize_text_field',
			'_earlystart_es_curriculum_stage_discovery_title'  => 'sanitize_text_field',
			'curriculum_stage_discovery_desc'   => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_stage_discovery_desc'   => 'sanitize_textarea_field',
			'curriculum_stage_readiness_title'  => 'sanitize_text_field',
			'_earlystart_es_curriculum_stage_readiness_title'  => 'sanitize_text_field',
			'curriculum_stage_readiness_desc'   => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_stage_readiness_desc'   => 'sanitize_textarea_field',
		),
		'earlystart_curriculum_environment_nonce' => array(
			'curriculum_env_badge'             => 'sanitize_text_field',
			'_earlystart_es_curriculum_env_badge'             => 'sanitize_text_field',
			'curriculum_env_title'             => 'sanitize_text_field',
			'_earlystart_es_curriculum_env_title'             => 'sanitize_text_field',
			'curriculum_env_description'       => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_env_description'       => 'sanitize_textarea_field',
			'curriculum_zone_construction_emoji' => 'sanitize_text_field',
			'curriculum_zone_construction_title' => 'sanitize_text_field',
			'_earlystart_es_curriculum_zone_construction_title' => 'sanitize_text_field',
			'curriculum_zone_construction_desc'  => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_zone_construction_desc'  => 'sanitize_textarea_field',
			'curriculum_zone_atelier_emoji'      => 'sanitize_text_field',
			'curriculum_zone_atelier_title'      => 'sanitize_text_field',
			'_earlystart_es_curriculum_zone_atelier_title'      => 'sanitize_text_field',
			'curriculum_zone_atelier_desc'       => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_zone_atelier_desc'       => 'sanitize_textarea_field',
			'curriculum_zone_literacy_emoji'     => 'sanitize_text_field',
			'curriculum_zone_literacy_title'     => 'sanitize_text_field',
			'_earlystart_es_curriculum_zone_literacy_title'     => 'sanitize_text_field',
			'curriculum_zone_literacy_desc'      => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_zone_literacy_desc'      => 'sanitize_textarea_field',
		),
		'earlystart_curriculum_milestones_nonce' => array(
			'curriculum_milestones_title'           => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestones_title'           => 'sanitize_text_field',
			'curriculum_milestones_subtitle'        => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestones_subtitle'        => 'sanitize_text_field',
			'curriculum_milestone_tracking_icon'    => 'sanitize_text_field',
			'curriculum_milestone_tracking_title'   => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_tracking_title'   => 'sanitize_text_field',
			'curriculum_milestone_tracking_desc'    => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_milestone_tracking_desc'    => 'sanitize_textarea_field',
			'curriculum_milestone_tracking_bullet1' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_tracking_bullet1' => 'sanitize_text_field',
			'curriculum_milestone_tracking_bullet2' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_tracking_bullet2' => 'sanitize_text_field',
			'curriculum_milestone_screenings_icon'    => 'sanitize_text_field',
			'curriculum_milestone_screenings_title'   => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_screenings_title'   => 'sanitize_text_field',
			'curriculum_milestone_screenings_desc'    => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_milestone_screenings_desc'    => 'sanitize_textarea_field',
			'curriculum_milestone_screenings_bullet1' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_screenings_bullet1' => 'sanitize_text_field',
			'curriculum_milestone_screenings_bullet2' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_screenings_bullet2' => 'sanitize_text_field',
			'curriculum_milestone_assessments_icon'    => 'sanitize_text_field',
			'curriculum_milestone_assessments_title'   => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_assessments_title'   => 'sanitize_text_field',
			'curriculum_milestone_assessments_desc'    => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_milestone_assessments_desc'    => 'sanitize_textarea_field',
			'curriculum_milestone_assessments_bullet1' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_assessments_bullet1' => 'sanitize_text_field',
			'curriculum_milestone_assessments_bullet2' => 'sanitize_text_field',
			'_earlystart_es_curriculum_milestone_assessments_bullet2' => 'sanitize_text_field',
		),
		'earlystart_curriculum_cta_nonce' => array(
			'curriculum_cta_title'       => 'sanitize_text_field',
			'_earlystart_es_curriculum_cta_title'       => 'sanitize_text_field',
			'curriculum_cta_description' => 'sanitize_textarea_field',
			'_earlystart_es_curriculum_cta_description' => 'sanitize_textarea_field',
		),
	);
...
add_action( 'save_post', 'earlystart_save_curriculum_page_meta' );

/**
 * Seed default values for Curriculum page
 */
function earlystart_seed_curriculum_page_defaults( $post_id ) {
	if ( get_post_type( $post_id ) !== 'page' ) {
		return;
	}
...
add_action( 'save_post', 'earlystart_seed_curriculum_page_defaults', 5 );
