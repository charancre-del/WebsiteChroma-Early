...
function earlystart_seed_core_content()
{
    ...
    $about_meta = array(
        ...
        'about_nutrition_description' => 'Whole-child care includes how children feel, regulate, and participate throughout the day, including mealtimes and sensory needs.',
    ...
    $curriculum_meta = array(
        ...
        'curriculum_cta_description' => 'Schedule a tour to see how our spaces, routines, and team bring the Chroma care model to life.',
    ...
    $employers_meta = array(
        ...
        'employers_tax_description' => 'Partnering with Early Start is not just a culture investment. State and federal programs can help offset childcare benefit costs.',
        ...
        'employers_federal_desc' => 'Businesses may qualify for significant credits tied to employer-sponsored childcare investments. Confirm details with your tax advisor before relying on specific incentives.',
        ...
        'employers_georgia_desc' => 'Georgia maintains employer childcare incentives that can improve the economics of offering childcare support to employees.',
    ...
    $home_services = array(
        array('id' => 'aba', 'title' => 'ABA Therapy', 'subtitle' => 'Applied Behavior Analysis', 'icon' => 'puzzle', 'heading' => 'Individualized Behavioral Growth', 'description' => 'Our ABA therapy focuses on increasing helpful behaviors and decreasing harmful ones to improve learning and social skills.', 'image' => 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&q=80&fm=webp?w=800&fit=crop&q=80&fm=webp', 'bullets' => array('One-on-one sessions', 'Data-driven progress tracking', 'Positive reinforcement focus')),
        array('id' => 'speech', 'title' => 'Speech Therapy', 'subtitle' => 'Communication Skills', 'icon' => 'message-circle', 'heading' => 'Unlocking Every Voice', 'description' => 'Specialized support for articulation, language comprehension, and social communication milestones.', 'image' => 'https://images.unsplash.com/photo-1544717305-27a734ef202e?auto=format&fit=crop&q=80&fm=webp?w=800&fit=crop&q=80&fm=webp', 'bullets' => array('Articulation support', 'Social language skills', 'Early intervention focus')),
        array('id' => 'ot', 'title' => 'Occupational Therapy', 'subtitle' => 'Daily Living Skills', 'icon' => 'hand', 'heading' => 'Developing Independence', 'description' => 'Helping children build the fine motor, sensory, and cognitive skills needed for daily life and play.', 'image' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&fm=webp?w=800&fit=crop&q=80&fm=webp', 'bullets' => array('Fine motor development', 'Sensory integration', 'Self-regulation tools')),
    );
    ...
    $locations = array(
        'cherokee-academy' => array('title' => 'Cherokee Academy by Early Start Early Learning', 'region' => 'Cherokee', 'address' => '1205 Upper Burris Road', 'city' => 'Canton', 'state' => 'GA', 'zip' => '30114', 'latitude' => '34.2368', 'longitude' => '-84.4908'),
        'east-cobb-campus' => array('title' => 'East Cobb Campus', 'region' => 'Cobb', 'address' => '2499 Shallowford Road NE', 'city' => 'Marietta', 'state' => 'GA', 'zip' => '30066', 'latitude' => '34.0250', 'longitude' => '-84.4870'),
        'ellenwood-campus' => array('title' => 'Ellenwood Campus', 'region' => 'Dekalb', 'address' => '2765 E Atlanta Road', 'city' => 'Ellenwood', 'state' => 'GA', 'zip' => '30294', 'latitude' => '33.6163', 'longitude' => '-84.2933', 'featured' => true),
        ...
        'jonesboro-campus' => array('title' => 'Jonesboro Campus', 'region' => 'Clayton', 'address' => '1832 Noahs Ark Road', 'city' => 'Jonesboro', 'state' => 'GA', 'zip' => '30236', 'latitude' => '33.5215', 'longitude' => '-84.3538'),
        'lawrenceville-campus' => array('title' => 'Lawrenceville Campus', 'region' => 'Gwinnett', 'address' => '3650 Club Drive', 'city' => 'Lawrenceville', 'state' => 'GA', 'zip' => '30044', 'latitude' => '33.9412', 'longitude' => '-84.0146'),
        'lilburn-campus' => array('title' => 'Lilburn Campus', 'region' => 'Gwinnett', 'address' => '917 Killian Hill Road SW', 'city' => 'Lilburn', 'state' => 'GA', 'zip' => '30047', 'latitude' => '33.8901', 'longitude' => '-84.1421'),
        ...
        'midway-campus' => array('title' => 'Midway Campus', 'region' => 'Fulton', 'address' => '4015 Discovery Drive', 'city' => 'Alpharetta', 'state' => 'GA', 'zip' => '30004', 'latitude' => '34.1570', 'longitude' => '-84.2577'),
        'newnan-campus' => array('title' => 'Newnan Campus', 'region' => 'Coweta', 'address' => '40 Bledsoe Road', 'city' => 'Newnan', 'state' => 'GA', 'zip' => '30265', 'latitude' => '33.3946', 'longitude' => '-84.7477'),
        'north-hall-campus' => array('title' => 'North Hall Campus, Murraysville', 'region' => 'Hall', 'address' => '5760 Wade Whelchel Road', 'city' => 'Murraysville', 'state' => 'GA', 'zip' => '30564', 'latitude' => '34.3387', 'longitude' => '-83.9007'),
        'pleasanthill-campus' => array('title' => 'Pleasanthill Campus, Duluth', 'region' => 'Gwinnett', 'address' => '3152 Creek Drive NW', 'city' => 'Duluth', 'state' => 'GA', 'zip' => '30096', 'latitude' => '33.9609', 'longitude' => '-84.1226', 'featured' => true),
        'rivergreen-campus' => array('title' => 'Rivergreen Campus', 'region' => 'Cherokee', 'address' => '200 River Green Avenue', 'city' => 'Canton', 'state' => 'GA', 'zip' => '30114', 'latitude' => '34.2357', 'longitude' => '-84.4707'),
        'roswell-campus' => array('title' => 'Roswell Campus', 'region' => 'Fulton', 'address' => '1255 Upper Hembree Road', 'city' => 'Roswell', 'state' => 'GA', 'zip' => '30076', 'latitude' => '34.0362', 'longitude' => '-84.3310'),
        'satellite-blvd-campus' => array('title' => 'Satellite Bvd Campus', 'region' => 'Gwinnett', 'address' => '3730 Satellite Boulevard', 'city' => 'Duluth', 'state' => 'GA', 'zip' => '30096', 'latitude' => '33.9895', 'longitude' => '-84.1360'),
        'south-cobb-campus' => array('title' => 'South Cobb Campus, Austell', 'region' => 'Cobb', 'address' => '7225 Premier Lane', 'city' => 'Austell', 'state' => 'GA', 'zip' => '30168', 'latitude' => '33.7833', 'longitude' => '-84.6206'),
        'tramore-campus' => array('title' => 'Tramore Campus', 'region' => 'Cobb', 'address' => '2081 Mesa Valley Way', 'city' => 'Austell', 'state' => 'GA', 'zip' => '30106', 'latitude' => '33.8182', 'longitude' => '-84.6264'),
        'tyrone-campus' => array('title' => 'Tyrone Campus', 'region' => 'Fayette', 'address' => '291 Jenkins Road', 'city' => 'Tyrone', 'state' => 'GA', 'zip' => '30290', 'latitude' => '33.4718', 'longitude' => '-84.5916', 'featured' => true),
        'west-cobb-campus' => array('title' => 'West Cobb Campus', 'region' => 'Cobb', 'address' => '2424 Powder Springs Road SW', 'city' => 'Marietta', 'state' => 'GA', 'zip' => '30064', 'latitude' => '33.9190', 'longitude' => '-84.5977', 'featured' => true),
    );
