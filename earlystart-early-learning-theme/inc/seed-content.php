...
function earlystart_build_seed_location_meta(array $location)
{
    ...
    return array(
        ...
        'location_seo_content_text' => $location['seo_text'] ?? sprintf('Families in %s, %s choose Chroma Early Start for coordinated autism assessment, behavioral assessment, ADHD assessment, ABA therapy, speech therapy, and occupational therapy delivered in a supportive clinic setting designed for early learners.', $city, $state),
    ...
    $pages = array(
        'home' => array(
            ...
            'meta' => array(
                ...
                'home_hero_subheading' => 'Specialized autism assessment, behavioral assessment, ADHD assessment, ABA therapy, speech therapy, and occupational therapy tailored to your child\'s unique journey. Our integrated clinical approach helps children thrive in a supportive, play-based environment.',
                ...
                'home_prismpath_readiness_desc' => 'Integrating assessment, speech, OT, and ABA for holistic outcomes.',
