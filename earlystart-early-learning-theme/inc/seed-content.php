...
function earlystart_build_seed_location_meta(array $location)
{
    ...
    return array(
        ...
        'location_seo_content_text' => $location['seo_text'] ?? sprintf('Families in %s, %s choose Chroma Early Start for coordinated autism diagnosis, ABA therapy, behavioral health, speech therapy, and occupational therapy delivered in a supportive clinic setting designed for early learners.', $city, $state),
        ...
        'location_special_programs' => $location['special_programs'] ?? "Autism Diagnosis\nABA Therapy\nBehavioral Health\nSpeech Therapy\nOccupational Therapy\nParent Coaching",
...
function earlystart_seed_core_content()
{
    ...
    $home_services = array(
        array('id' => 'autism-diagnosis', 'title' => 'Autism Diagnosis', 'subtitle' => 'Diagnostic Evaluation', 'icon' => 'clipboard-check', 'heading' => 'Clear Answers for Next Steps', 'description' => 'Comprehensive autism diagnostic evaluations help families understand developmental needs and plan the right care pathway.', 'image' => 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?auto=format&fit=crop&w=800&q=80&fm=webp', 'bullets' => array('Developmental history review', 'Standardized diagnostic tools', 'Care planning guidance')),
        ...
        array('id' => 'behavioral-health', 'title' => 'Behavioral Health', 'subtitle' => 'Mental & Emotional Support', 'icon' => 'heart-pulse', 'heading' => 'Whole-Child Behavioral Support', 'description' => 'Behavioral health services support emotional regulation, coping skills, family routines, and coordinated care for children and caregivers.', 'image' => 'https://images.unsplash.com/photo-1536640712-4d4c36ff0e4e?auto=format&fit=crop&w=800&q=80&fm=webp', 'bullets' => array('Emotional regulation support', 'Family-centered care plans', 'Coordinated clinical guidance')),
    ...
    $pages = array(
        'home' => array(
            ...
            'meta' => array(
                ...
                'home_hero_subheading' => 'Specialized autism diagnosis, ABA therapy, behavioral health, speech therapy, and occupational therapy tailored to your child\'s unique journey. Our integrated clinical approach helps children thrive in a supportive, play-based environment.',
                ...
                'home_prismpath_readiness_desc' => 'Integrating diagnosis, behavioral health, speech, OT, and ABA for holistic outcomes.',
    ...
    $programs = array(
        'autism-diagnosis' => array('title' => 'Autism Diagnosis', 'excerpt' => 'Comprehensive autism diagnostic evaluations that help families understand needs and next steps.', 'meta' => array('program_icon' => 'clipboard-check', 'program_age_range' => '18mo - 12y', 'program_color_scheme' => 'rose', 'program_hero_title' => 'Clear Answers for Next Steps.', 'program_hero_description' => 'Our diagnostic evaluation pathway helps families understand developmental needs, document clinical findings, and plan the right support.', 'program_prism_title' => 'Diagnostic Core', 'program_prism_physical' => 20, 'program_prism_emotional' => 80, 'program_prism_social' => 75, 'program_prism_academic' => 60, 'program_prism_creative' => 40)),
        ...
        'behavioral-health' => array('title' => 'Behavioral Health', 'excerpt' => 'Behavioral health support for emotional regulation, coping skills, and family-centered care.', 'meta' => array('program_icon' => 'heart-pulse', 'program_age_range' => '2y - 12y', 'program_color_scheme' => 'orange', 'program_hero_title' => 'Whole-Child Behavioral Support.', 'program_hero_description' => 'Our behavioral health services support emotional regulation, coping skills, caregiver guidance, and coordinated care for children and families.', 'program_prism_title' => 'Behavioral Health Core', 'program_prism_physical' => 25, 'program_prism_emotional' => 95, 'program_prism_social' => 80, 'program_prism_academic' => 45, 'program_prism_creative' => 55)),
