 ...
 */
function earlystart_about_page_meta_boxes() {
	add_meta_box(
		'chroma-about-hero',
		__( 'Hero Section', 'earlystart-early-learning' ),
		'earlystart_about_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		...
		__( 'Mission Section', 'earlystart-early-learning' ),
		'earlystart_about_mission_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'chroma-about-story',
		__( 'Story Section', 'earlystart-early-learning' ),
		'earlystart_about_story_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'chroma-about-values',
		__( 'Values (Early Start Standard) Section', 'earlystart-early-learning' ),
		'earlystart_about_values_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Leadership Section', 'earlystart-early-learning' ),
		'earlystart_about_leadership_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Nutrition & Wellness Section', 'earlystart-early-learning' ),
		'earlystart_about_nutrition_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Philanthropy Section', 'earlystart-early-learning' ),
		'earlystart_about_philanthropy_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'chroma-about-cta',
		__( 'CTA Section', 'earlystart-early-learning' ),
		'earlystart_about_cta_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'earlystart_about_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function earlystart_about_hero_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_hero_meta', 'earlystart_about_hero_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_about_hero_badge_text" name="_earlystart_es_about_hero_badge_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_hero_badge_text', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_about_hero_title" name="_earlystart_es_about_hero_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_hero_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_hero_description" name="_earlystart_es_about_hero_description"
						  rows="4" class="large-text" placeholder="[ES] Hero Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_hero_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
 ...
 */
function earlystart_about_mission_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_mission_meta', 'earlystart_about_mission_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_mission_quote" name="_earlystart_es_about_mission_quote"
						  rows="5" class="large-text" placeholder="[ES] Mission Quote" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_mission_quote', true ) ); ?></textarea>
 ...
 */
function earlystart_about_story_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_story_meta', 'earlystart_about_story_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="about_story_title" name="about_story_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_story_title" name="_earlystart_es_about_story_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_story_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_story_paragraph1" name="_earlystart_es_about_story_paragraph1"
						  rows="4" class="large-text" placeholder="[ES] Paragraph 1" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_story_paragraph1', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_story_paragraph2" name="_earlystart_es_about_story_paragraph2"
						  rows="4" class="large-text" placeholder="[ES] Paragraph 2" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_story_paragraph2', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
 ...
 */
function earlystart_about_educators_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_educators_meta', 'earlystart_about_educators_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="about_educators_title" name="about_educators_title"
					   ...
					   class="large-text" placeholder="e.g., The Heart of Early Start." />
				<br>
				<input type="text" id="_earlystart_es_about_educators_title" name="_earlystart_es_about_educators_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_educators_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_educators_description" name="_earlystart_es_about_educators_description"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_educators_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_educator1_title" name="about_educator1_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_educator1_title" name="_earlystart_es_about_educator1_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_educator1_title', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_educator1_desc" name="_earlystart_es_about_educator1_desc"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_educator1_desc', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_educator2_title" name="about_educator2_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_educator2_title" name="_earlystart_es_about_educator2_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_educator2_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_educator2_desc" name="_earlystart_es_about_educator2_desc"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_educator2_desc', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_educator3_title" name="about_educator3_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_educator3_title" name="_earlystart_es_about_educator3_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_educator3_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_educator3_desc" name="_earlystart_es_about_educator3_desc"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_educator3_desc', true ) ); ?></textarea>
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function earlystart_about_values_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_values_meta', 'earlystart_about_values_nonce' );
		...
		<tr>
			...
			<td>
				<input type="text" id="about_values_title" name="about_values_title"
					   ...
					   class="large-text" placeholder="e.g., The Early Start Standard" />
				<br>
				<input type="text" id="_earlystart_es_about_values_title" name="_earlystart_es_about_values_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_values_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Section Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_values_description" name="_earlystart_es_about_values_description"
						  rows="3" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_values_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_value1_title" name="about_value1_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_value1_title" name="_earlystart_es_about_value1_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_value1_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_value1_desc" name="_earlystart_es_about_value1_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_value1_desc', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_value2_title" name="about_value2_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_value2_title" name="_earlystart_es_about_value2_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_value2_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_value2_desc" name="_earlystart_es_about_value2_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_value2_desc', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_value3_title" name="about_value3_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_value3_title" name="_earlystart_es_about_value3_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_value3_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_value3_desc" name="_earlystart_es_about_value3_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_value3_desc', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input type="text" id="about_value4_title" name="about_value4_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_value4_title" name="_earlystart_es_about_value4_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_value4_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_value4_desc" name="_earlystart_es_about_value4_desc"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_value4_desc', true ) ); ?></textarea>
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function earlystart_about_leadership_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_leadership_meta', 'earlystart_about_leadership_nonce' );
 ...
 */
function earlystart_about_nutrition_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_nutrition_meta', 'earlystart_about_nutrition_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="about_nutrition_title" name="about_nutrition_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_nutrition_title" name="_earlystart_es_about_nutrition_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_nutrition_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_nutrition_description" name="_earlystart_es_about_nutrition_description"
						  rows="4" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_nutrition_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_about_nutrition_bullet1_text" name="_earlystart_es_about_nutrition_bullet1_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_nutrition_bullet1_text', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<input type="text" id="about_nutrition_bullet2_text" name="about_nutrition_bullet2_text"
					   ...
					   placeholder="Text" class="large-text" style="margin-left: 10px;" />
				<br>
				<input type="text" id="_earlystart_es_about_nutrition_bullet2_text" name="_earlystart_es_about_nutrition_bullet2_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_nutrition_bullet2_text', true ) ); ?>"
					   placeholder="[ES] Text" class="large-text" style="margin-left: 10px; margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<input type="text" id="about_nutrition_bullet3_text" name="about_nutrition_bullet3_text"
					   ...
					   placeholder="Text" class="large-text" style="margin-left: 10px;" />
				<br>
				<input type="text" id="_earlystart_es_about_nutrition_bullet3_text" name="_earlystart_es_about_nutrition_bullet3_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_nutrition_bullet3_text', true ) ); ?>"
					   placeholder="[ES] Text" class="large-text" style="margin-left: 10px; margin-top: 5px;" />
			</td>
		</tr>
		<tr>
 ...
 */
function earlystart_about_philanthropy_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_philanthropy_meta', 'earlystart_about_philanthropy_nonce' );
	...
	<table class="form-table">
		<tr>
			...
			<td>
				<input type="text" id="about_philanthropy_title" name="about_philanthropy_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_philanthropy_title" name="_earlystart_es_about_philanthropy_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<input type="text" id="_earlystart_es_about_philanthropy_subtitle" name="_earlystart_es_about_philanthropy_subtitle"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_subtitle', true ) ); ?>"
		...
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_philanthropy_description" name="_earlystart_es_about_philanthropy_description"
						  rows="4" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_description', true ) ); ?></textarea>
			</td>
		</tr>
		<tr>
			<th colspan="2"><strong>Bullet Points</strong></th>
		...
		<tr>
			...
			<td>
				...
				<input type="text" id="about_philanthropy_bullet1_text" name="about_philanthropy_bullet1_text"
					   ...
					   placeholder="Text" class="large-text" style="margin-left: 10px;" />
				<br>
				<input type="text" id="_earlystart_es_about_philanthropy_bullet1_text" name="_earlystart_es_about_philanthropy_bullet1_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_bullet1_text', true ) ); ?>"
					   placeholder="[ES] Text" class="large-text" style="margin-left: 10px; margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<input type="text" id="about_philanthropy_bullet2_text" name="about_philanthropy_bullet2_text"
					   ...
					   placeholder="Text" class="large-text" style="margin-left: 10px;" />
				<br>
				<input type="text" id="_earlystart_es_about_philanthropy_bullet2_text" name="_earlystart_es_about_philanthropy_bullet2_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_bullet2_text', true ) ); ?>"
					   placeholder="[ES] Text" class="large-text" style="margin-left: 10px; margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<input type="text" id="about_philanthropy_bullet3_text" name="about_philanthropy_bullet3_text"
					   ...
					   placeholder="Text" class="large-text" style="margin-left: 10px;" />
				<br>
				<input type="text" id="_earlystart_es_about_philanthropy_bullet3_text" name="_earlystart_es_about_philanthropy_bullet3_text"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_philanthropy_bullet3_text', true ) ); ?>"
					   placeholder="[ES] Text" class="large-text" style="margin-left: 10px; margin-top: 5px;" />
			</td>
		</tr>
		<tr>
 ...
 */
function earlystart_about_cta_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_about_cta_meta', 'earlystart_about_cta_nonce' );
		...
		<tr>
			...
			<td>
				<input type="text" id="about_cta_title" name="about_cta_title"
					   ...
					   class="large-text" />
				<br>
				<input type="text" id="_earlystart_es_about_cta_title" name="_earlystart_es_about_cta_title"
					   value="<?php echo esc_attr( get_post_meta( $post->ID, '_earlystart_es_about_cta_title', true ) ); ?>"
					   class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<br>
				<textarea id="_earlystart_es_about_cta_description" name="_earlystart_es_about_cta_description"
						  rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea( get_post_meta( $post->ID, '_earlystart_es_about_cta_description', true ) ); ?></textarea>
			</td>
		</tr>
	</table>
	<?php
 ...
 */
function earlystart_save_about_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'earlystart_about_hero_nonce' => array(
			'about_hero_badge_text'  => 'sanitize_text_field',
			'_earlystart_es_about_hero_badge_text'  => 'sanitize_text_field',
			'about_hero_title'       => 'sanitize_text_field',
			'_earlystart_es_about_hero_title'       => 'sanitize_text_field',
			'about_hero_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_hero_description' => 'sanitize_textarea_field',
			'about_hero_image'       => 'esc_url_raw',
		),
		'earlystart_about_mission_nonce' => array(
			'about_mission_quote' => 'sanitize_textarea_field',
			'_earlystart_es_about_mission_quote' => 'sanitize_textarea_field',
		),
		'earlystart_about_story_nonce' => array(
			'about_story_title'      => 'sanitize_text_field',
			'_earlystart_es_about_story_title' => 'sanitize_text_field',
			'about_story_paragraph1' => 'sanitize_textarea_field',
			'_earlystart_es_about_story_paragraph1' => 'sanitize_textarea_field',
			'about_story_paragraph2' => 'sanitize_textarea_field',
			'_earlystart_es_about_story_paragraph2' => 'sanitize_textarea_field',
			'about_story_image'      => 'esc_url_raw',
			'about_stat1_value'      => 'sanitize_text_field',
			'about_stat1_label'      => 'sanitize_text_field',
			'_earlystart_es_about_stat1_label' => 'sanitize_text_field',
			'about_stat2_value'      => 'sanitize_text_field',
			'about_stat2_label'      => 'sanitize_text_field',
			'_earlystart_es_about_stat2_label' => 'sanitize_text_field',
			'about_stat3_value'      => 'sanitize_text_field',
			'about_stat3_label'      => 'sanitize_text_field',
			'_earlystart_es_about_stat3_label' => 'sanitize_text_field',
			'about_stat4_value'      => 'sanitize_text_field',
			'about_stat4_label'      => 'sanitize_text_field',
			'_earlystart_es_about_stat4_label' => 'sanitize_text_field',
		),
		'earlystart_about_educators_nonce' => array(
			'about_educators_title'       => 'sanitize_text_field',
			'_earlystart_es_about_educators_title' => 'sanitize_text_field',
			'about_educators_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_educators_description' => 'sanitize_textarea_field',
			'about_educator1_icon' => 'sanitize_text_field',
			'about_educator1_title' => 'sanitize_text_field',
			'_earlystart_es_about_educator1_title' => 'sanitize_text_field',
			'about_educator1_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_educator1_desc' => 'sanitize_textarea_field',
			'about_educator2_icon' => 'sanitize_text_field',
			'about_educator2_title' => 'sanitize_text_field',
			'_earlystart_es_about_educator2_title' => 'sanitize_text_field',
			'about_educator2_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_educator2_desc' => 'sanitize_textarea_field',
			'about_educator3_icon' => 'sanitize_text_field',
			'about_educator3_title' => 'sanitize_text_field',
			'_earlystart_es_about_educator3_title' => 'sanitize_text_field',
			'about_educator3_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_educator3_desc' => 'sanitize_textarea_field',
		),
		'earlystart_about_values_nonce' => array(
			'about_values_title' => 'sanitize_text_field',
			'_earlystart_es_about_values_title' => 'sanitize_text_field',
			'about_values_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_values_description' => 'sanitize_textarea_field',
			'about_value1_icon' => 'sanitize_text_field',
			'about_value1_title' => 'sanitize_text_field',
			'_earlystart_es_about_value1_title' => 'sanitize_text_field',
			'about_value1_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_value1_desc' => 'sanitize_textarea_field',
			'about_value2_icon' => 'sanitize_text_field',
			'about_value2_title' => 'sanitize_text_field',
			'_earlystart_es_about_value2_title' => 'sanitize_text_field',
			'about_value2_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_value2_desc' => 'sanitize_textarea_field',
			'about_value3_icon' => 'sanitize_text_field',
			'about_value3_title' => 'sanitize_text_field',
			'_earlystart_es_about_value3_title' => 'sanitize_text_field',
			'about_value3_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_value3_desc' => 'sanitize_textarea_field',
			'about_value4_icon' => 'sanitize_text_field',
			'about_value4_title' => 'sanitize_text_field',
			'_earlystart_es_about_value4_title' => 'sanitize_text_field',
			'about_value4_desc' => 'sanitize_textarea_field',
			'_earlystart_es_about_value4_desc' => 'sanitize_textarea_field',
		),
		'earlystart_about_leadership_nonce' => array(
			'about_leadership_title' => 'sanitize_text_field',
			'_earlystart_es_about_leadership_title' => 'sanitize_text_field',
		),
		'earlystart_about_nutrition_nonce' => array(
			'about_nutrition_title' => 'sanitize_text_field',
			'_earlystart_es_about_nutrition_title' => 'sanitize_text_field',
			'about_nutrition_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_nutrition_description' => 'sanitize_textarea_field',
			...
			'_earlystart_es_about_nutrition_bullet1_text' => 'sanitize_text_field',
			'about_nutrition_bullet2_icon' => 'sanitize_text_field',
			'about_nutrition_bullet2_text' => 'sanitize_text_field',
			'_earlystart_es_about_nutrition_bullet2_text' => 'sanitize_text_field',
			'about_nutrition_bullet3_icon' => 'sanitize_text_field',
			'about_nutrition_bullet3_text' => 'sanitize_text_field',
			'_earlystart_es_about_nutrition_bullet3_text' => 'sanitize_text_field',
		),
		'earlystart_about_philanthropy_nonce' => array(
			'about_philanthropy_title' => 'sanitize_text_field',
			'_earlystart_es_about_philanthropy_title' => 'sanitize_text_field',
			'about_philanthropy_subtitle' => 'sanitize_text_field',
			'_earlystart_es_about_philanthropy_subtitle' => 'sanitize_text_field',
			'about_philanthropy_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_philanthropy_description' => 'sanitize_textarea_field',
			...
			'_earlystart_es_about_philanthropy_bullet1_text' => 'sanitize_text_field',
			'about_philanthropy_bullet2_icon' => 'sanitize_text_field',
			'about_philanthropy_bullet2_text' => 'sanitize_text_field',
			'_earlystart_es_about_philanthropy_bullet2_text' => 'sanitize_text_field',
			'about_philanthropy_bullet3_icon' => 'sanitize_text_field',
			'about_philanthropy_bullet3_text' => 'sanitize_text_field',
			'_earlystart_es_about_philanthropy_bullet3_text' => 'sanitize_text_field',
		),
		'earlystart_about_cta_nonce' => array(
			'about_cta_title' => 'sanitize_text_field',
			'_earlystart_es_about_cta_title' => 'sanitize_text_field',
			'about_cta_description' => 'sanitize_textarea_field',
			'_earlystart_es_about_cta_description' => 'sanitize_textarea_field',
		),
	);
...
add_action( 'save_post', 'earlystart_save_about_page_meta' );

/**
 * Seed default values for About page when template is first applied
 */
function earlystart_seed_about_page_defaults( $post_id ) {
	...
	$defaults = array(
		...
		'about_educator1_desc'             => 'Our team includes licensed and board-certified professionals across autism diagnosis, ABA, behavioral health, speech, and occupational therapy disciplines.',
		...
		'about_cta_description'            => 'Come see why over 2,000 families trust Early Start with their children\'s early years.',
	);
...
add_action( 'save_post', 'earlystart_seed_about_page_defaults', 5 );
