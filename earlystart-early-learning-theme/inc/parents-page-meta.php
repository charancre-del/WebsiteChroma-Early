 ...
 * Register Meta Boxes
 */
function earlystart_parents_page_meta_boxes()
{
    global $post;
    ...
    add_meta_box(
        ...
        'earlystart_parents_hero_meta_box_render',
        'page',
        'normal',
        'high'
    );
    ...
    add_meta_box(
        ...
        __('Quick Links / Resources', 'earlystart-early-learning'),
        'earlystart_parents_resources_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        ...
        __('Events Section', 'earlystart-early-learning'),
        'earlystart_parents_events_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        ...
        __('Moments of Joy Gallery', 'earlystart-early-learning'),
        'earlystart_parents_gallery_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        ...
        __('Nutrition Section', 'earlystart-early-learning'),
        'earlystart_parents_nutrition_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        ...
        __('Safety Section', 'earlystart-early-learning'),
        'earlystart_parents_safety_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        'chroma-parents-faq',
        __('FAQ Section', 'earlystart-early-learning'),
        'earlystart_parents_faq_meta_box_render',
        'page',
        'normal',
        'default'
    );
    ...
    add_meta_box(
        ...
        __('Referral Banner', 'earlystart-early-learning'),
        'earlystart_parents_referral_meta_box_render',
        'page',
        'normal',
        'default'
    );
}
add_action('add_meta_boxes', 'earlystart_parents_page_meta_boxes');

/**
 * Hero Section Meta Box
 */
function earlystart_parents_hero_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_hero_meta', 'earlystart_parents_hero_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_hero_badge" name="_earlystart_es_parents_hero_badge"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_hero_badge', true)); ?>" class="large-text" placeholder="[ES] Badge Text" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_hero_title" name="_earlystart_es_parents_hero_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_hero_title', true)); ?>" class="large-text" placeholder="[ES] Headline" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_hero_description" name="_earlystart_es_parents_hero_description" rows="3"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_hero_description', true)); ?></textarea>
            </td>
        </tr>
    </table>
    <?php
 ...
 * Resources Meta Box
 */
function earlystart_parents_resources_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_resources_meta', 'earlystart_parents_resources_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_essentials_title" name="_earlystart_es_parents_essentials_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_essentials_title', true)); ?>" class="large-text" placeholder="[ES] Section Title" style="margin-top: 5px;" />
            </td>
        </tr>
    </table>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="parents_resource_<?php echo $key; ?>_title"
                        ...
                        class="large-text" />
                    <br>
                    <input type="text" id="_earlystart_es_parents_resource_<?php echo $key; ?>_title"
                        name="_earlystart_es_parents_resource_<?php echo $key; ?>_title" value="<?php echo esc_attr(get_post_meta($post->ID, "_earlystart_es_parents_resource_{$key}_title", true)); ?>"
            ...
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <textarea id="_earlystart_es_parents_resource_<?php echo $key; ?>_desc" name="_earlystart_es_parents_resource_<?php echo $key; ?>_desc"
                        rows="2" class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, "_earlystart_es_parents_resource_{$key}_desc", true)); ?></textarea>
                </td>
            </tr>
            <tr>
 ...
 */
function earlystart_parents_events_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_events_meta', 'earlystart_parents_events_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_events_badge" name="_earlystart_es_parents_events_badge"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_events_badge', true)); ?>" class="large-text" placeholder="[ES] Badge" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_events_title" name="_earlystart_es_parents_events_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_events_title', true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_events_description" name="_earlystart_es_parents_events_description" rows="3"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_events_description', true)); ?></textarea>
            </td>
        </tr>
        <tr>
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <input type="text" id="_earlystart_es_parents_event<?php echo $num; ?>_title" name="_earlystart_es_parents_event<?php echo $num; ?>_title"
                        value="<?php echo esc_attr(get_post_meta($post->ID, "_earlystart_es_parents_event{$num}_title", true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <textarea id="_earlystart_es_parents_event<?php echo $num; ?>_desc" name="_earlystart_es_parents_event<?php echo $num; ?>_desc" rows="2"
                        class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, "_earlystart_es_parents_event{$num}_desc", true)); ?></textarea>
                </td>
            </tr>
        </table>
    <?php endforeach; ?>
 ...
 */
function earlystart_parents_nutrition_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_nutrition_meta', 'earlystart_parents_nutrition_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_nutrition_badge" name="_earlystart_es_parents_nutrition_badge"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_nutrition_badge', true)); ?>" class="large-text" placeholder="[ES] Badge" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_nutrition_title" name="_earlystart_es_parents_nutrition_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_nutrition_title', true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_nutrition_description" name="_earlystart_es_parents_nutrition_description" rows="3"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_nutrition_description', true)); ?></textarea>
            </td>
        </tr>
        <tr>
 ...
 */
function earlystart_parents_safety_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_safety_meta', 'earlystart_parents_safety_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_safety_title" name="_earlystart_es_parents_safety_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_safety_title', true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_safety_description" name="_earlystart_es_parents_safety_description" rows="3"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_safety_description', true)); ?></textarea>
            </td>
        </tr>
    </table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="parents_safety<?php echo $num; ?>_title"
                        ...
                        class="large-text" />
                    <br>
                    <input type="text" id="_earlystart_es_parents_safety<?php echo $num; ?>_title"
                        name="_earlystart_es_parents_safety<?php echo $num; ?>_title" value="<?php echo esc_attr(get_post_meta($post->ID, "_earlystart_es_parents_safety{$num}_title", true)); ?>"
                        class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
                </td>
            </tr>
            <tr>
 ...
 */
function earlystart_parents_faq_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_faq_meta', 'earlystart_parents_faq_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_faq_title" name="_earlystart_es_parents_faq_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_faq_title', true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_faq_description" name="_earlystart_es_parents_faq_description" rows="2"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_faq_description', true)); ?></textarea>
            </td>
        </tr>
    </table>
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" id="parents_faq<?php echo $num; ?>_question"
                        ...
                        class="large-text" />
                    <br>
                    <input type="text" id="_earlystart_es_parents_faq<?php echo $num; ?>_question"
                        name="_earlystart_es_parents_faq<?php echo $num; ?>_question" value="<?php echo esc_attr(get_post_meta($post->ID, "_earlystart_es_parents_faq{$num}_question", true)); ?>"
            ...
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <textarea id="_earlystart_es_parents_faq<?php echo $num; ?>_answer" name="_earlystart_es_parents_faq<?php echo $num; ?>_answer" rows="3"
                        class="large-text" placeholder="[ES] Answer" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, "_earlystart_es_parents_faq{$num}_answer", true)); ?></textarea>
                </td>
            </tr>
        </table>
    <?php endforeach; ?>
 ...
 */
function earlystart_parents_referral_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_referral_meta', 'earlystart_parents_referral_nonce');
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_referral_title" name="_earlystart_es_parents_referral_title"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_referral_title', true)); ?>" class="large-text" placeholder="[ES] Title" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <br>
                <textarea id="_earlystart_es_parents_referral_description" name="_earlystart_es_parents_referral_description" rows="2"
                    class="large-text" placeholder="[ES] Description" style="margin-top: 5px;"><?php echo esc_textarea(get_post_meta($post->ID, '_earlystart_es_parents_referral_description', true)); ?></textarea>
        ...
        <tr>
            ...
            <td>
                ...
                <br>
                <input type="text" id="_earlystart_es_parents_referral_button_text" name="_earlystart_es_parents_referral_button_text"
                    value="<?php echo esc_attr(get_post_meta($post->ID, '_earlystart_es_parents_referral_button_text', true)); ?>" placeholder="[ES] Button Text" style="margin-top: 5px;" />
            </td>
        </tr>
        <tr>
 ...
 * Gallery Meta Box
 */
function earlystart_parents_gallery_meta_box_render($post)
{
    wp_nonce_field('earlystart_parents_gallery_meta', 'earlystart_parents_gallery_nonce');
    $gallery = get_post_meta($post->ID, 'parents_moments_gallery', true);
    ?>
    <table class="form-table">
        <tr>
            <th><label for="parents_moments_gallery"><?php _e('Image Gallery (URLs)', 'earlystart-early-learning'); ?></label>
            </th>
            <td>
                ...
                <p class="description">
                    <?php _e('Enter one image URL per line. These will be displayed in the carousel.', 'earlystart-early-learning'); ?>
                </p>
            </td>
        </tr>
    </table>
 ...
 */
function earlystart_save_parents_page_meta($post_id)
{
    ...
    $meta_boxes = array(
        'earlystart_parents_hero_nonce' => array(
            'parents_hero_badge' => 'sanitize_text_field',
            '_earlystart_es_parents_hero_badge' => 'sanitize_text_field',
            'parents_hero_title' => 'sanitize_text_field',
            '_earlystart_es_parents_hero_title' => 'sanitize_text_field',
            'parents_hero_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_hero_description' => 'sanitize_textarea_field',
        ),
        'earlystart_parents_resources_nonce' => array(
            'parents_essentials_title' => 'sanitize_text_field',
            '_earlystart_es_parents_essentials_title' => 'sanitize_text_field',
            // Procare
            'parents_resource_procare_icon' => 'sanitize_text_field',
            'parents_resource_procare_title' => 'sanitize_text_field',
            '_earlystart_es_parents_resource_procare_title' => 'sanitize_text_field',
            ...
            '_earlystart_es_parents_resource_tuition_desc' => 'sanitize_textarea_field',
            ...
            '_earlystart_es_parents_resource_handbook_title' => 'sanitize_text_field',
            ...
            '_earlystart_es_parents_resource_prekga_desc' => 'sanitize_textarea_field',
            ...
            '_earlystart_es_parents_resource_waitlist_title' => 'sanitize_text_field',
            'parents_resource_waitlist_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_resource_waitlist_desc' => 'sanitize_textarea_field',
            'parents_resource_waitlist_url' => 'esc_url_raw',
        ),
        'earlystart_parents_events_nonce' => array(
            'parents_events_badge' => 'sanitize_text_field',
            '_earlystart_es_parents_events_badge' => 'sanitize_text_field',
            'parents_events_title' => 'sanitize_text_field',
            '_earlystart_es_parents_events_title' => 'sanitize_text_field',
            'parents_events_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_events_description' => 'sanitize_textarea_field',
            'parents_events_image' => 'esc_url_raw',
            'parents_event1_icon' => 'sanitize_text_field',
            'parents_event1_title' => 'sanitize_text_field',
            '_earlystart_es_parents_event1_title' => 'sanitize_text_field',
            'parents_event1_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_event1_desc' => 'sanitize_textarea_field',
            'parents_event2_icon' => 'sanitize_text_field',
            'parents_event2_title' => 'sanitize_text_field',
            '_earlystart_es_parents_event2_title' => 'sanitize_text_field',
            'parents_event2_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_event2_desc' => 'sanitize_textarea_field',
            'parents_event3_icon' => 'sanitize_text_field',
            'parents_event3_title' => 'sanitize_text_field',
            '_earlystart_es_parents_event3_title' => 'sanitize_text_field',
            'parents_event3_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_event3_desc' => 'sanitize_textarea_field',
        ),
        'earlystart_parents_gallery_nonce' => array(
            'parents_moments_gallery' => 'sanitize_textarea_field',
        ),
        'earlystart_parents_nutrition_nonce' => array(
            'parents_nutrition_badge' => 'sanitize_text_field',
            '_earlystart_es_parents_nutrition_badge' => 'sanitize_text_field',
            'parents_nutrition_title' => 'sanitize_text_field',
            '_earlystart_es_parents_nutrition_title' => 'sanitize_text_field',
            'parents_nutrition_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_nutrition_description' => 'sanitize_textarea_field',
            'parents_nutrition_image' => 'esc_url_raw',
            'parents_menu1_icon' => 'sanitize_text_field',
            'parents_menu1_title' => 'sanitize_text_field',
            '_earlystart_es_parents_menu1_title' => 'sanitize_text_field',
            'parents_menu1_subtitle' => 'sanitize_text_field',
            '_earlystart_es_parents_menu1_subtitle' => 'sanitize_text_field',
            'parents_menu1_url' => 'esc_url_raw',
            'parents_menu2_icon' => 'sanitize_text_field',
            'parents_menu2_title' => 'sanitize_text_field',
            '_earlystart_es_parents_menu2_title' => 'sanitize_text_field',
            'parents_menu2_subtitle' => 'sanitize_text_field',
            '_earlystart_es_parents_menu2_subtitle' => 'sanitize_text_field',
            'parents_menu2_url' => 'esc_url_raw',
            'parents_menu3_icon' => 'sanitize_text_field',
            'parents_menu3_title' => 'sanitize_text_field',
            '_earlystart_es_parents_menu3_title' => 'sanitize_text_field',
            'parents_menu3_subtitle' => 'sanitize_text_field',
            '_earlystart_es_parents_menu3_subtitle' => 'sanitize_text_field',
            'parents_menu3_url' => 'esc_url_raw',
        ),
        'earlystart_parents_safety_nonce' => array(
            'parents_safety_title' => 'sanitize_text_field',
            '_earlystart_es_parents_safety_title' => 'sanitize_text_field',
            'parents_safety_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_safety_description' => 'sanitize_textarea_field',
            'parents_safety1_icon' => 'sanitize_text_field',
            'parents_safety1_title' => 'sanitize_text_field',
            '_earlystart_es_parents_safety1_title' => 'sanitize_text_field',
            'parents_safety1_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_safety1_desc' => 'sanitize_textarea_field',
            'parents_safety2_icon' => 'sanitize_text_field',
            'parents_safety2_title' => 'sanitize_text_field',
            '_earlystart_es_parents_safety2_title' => 'sanitize_text_field',
            'parents_safety2_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_safety2_desc' => 'sanitize_textarea_field',
            'parents_safety3_icon' => 'sanitize_text_field',
            'parents_safety3_title' => 'sanitize_text_field',
            '_earlystart_es_parents_safety3_title' => 'sanitize_text_field',
            'parents_safety3_desc' => 'sanitize_textarea_field',
            '_earlystart_es_parents_safety3_desc' => 'sanitize_textarea_field',
        ),
        'earlystart_parents_faq_nonce' => array(
            'parents_faq_title' => 'sanitize_text_field',
            '_earlystart_es_parents_faq_title' => 'sanitize_text_field',
            'parents_faq_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_faq_description' => 'sanitize_textarea_field',
            'parents_faq1_question' => 'sanitize_text_field',
            '_earlystart_es_parents_faq1_question' => 'sanitize_text_field',
            'parents_faq1_answer' => 'sanitize_textarea_field',
            '_earlystart_es_parents_faq1_answer' => 'sanitize_textarea_field',
            'parents_faq2_question' => 'sanitize_text_field',
            '_earlystart_es_parents_faq2_question' => 'sanitize_text_field',
            'parents_faq2_answer' => 'sanitize_textarea_field',
            '_earlystart_es_parents_faq2_answer' => 'sanitize_textarea_field',
            'parents_faq3_question' => 'sanitize_text_field',
            '_earlystart_es_parents_faq3_question' => 'sanitize_text_field',
            'parents_faq3_answer' => 'sanitize_textarea_field',
            '_earlystart_es_parents_faq3_answer' => 'sanitize_textarea_field',
        ),
        'earlystart_parents_referral_nonce' => array(
            'parents_referral_title' => 'sanitize_text_field',
            '_earlystart_es_parents_referral_title' => 'sanitize_text_field',
            'parents_referral_description' => 'sanitize_textarea_field',
            '_earlystart_es_parents_referral_description' => 'sanitize_textarea_field',
            'parents_referral_button_text' => 'sanitize_text_field',
            '_earlystart_es_parents_referral_button_text' => 'sanitize_text_field',
...
add_action('save_post', 'earlystart_save_parents_page_meta');

/**
 * Seed Default Values on Activation/First Save
 */
function earlystart_seed_parents_page_defaults($post_id)
{
    if (get_post_type($post_id) !== 'page') {
        return;
    }
...
add_action('save_post', 'earlystart_seed_parents_page_defaults', 5);
