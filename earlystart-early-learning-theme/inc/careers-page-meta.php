 ...
 */
function earlystart_careers_page_meta_boxes() {
	add_meta_box(
		'chroma-careers-hero',
		__( 'Hero Section', 'earlystart-early-learning' ),
		'earlystart_careers_hero_meta_box_render',
		'page',
		'normal',
		'high'
	);
	...
	add_meta_box(
		...
		__( 'Culture & Benefits Section', 'earlystart-early-learning' ),
		'earlystart_careers_culture_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		...
		__( 'Current Opportunities Section (3 Job Listings)', 'earlystart-early-learning' ),
		'earlystart_careers_openings_meta_box_render',
		'page',
		'normal',
		'default'
	);
	...
	add_meta_box(
		'chroma-careers-cta',
		__( 'Application CTA Section', 'earlystart-early-learning' ),
		'earlystart_careers_cta_meta_box_render',
		'page',
		'normal',
		'default'
	);
}
add_action( 'add_meta_boxes', 'earlystart_careers_page_meta_boxes' );

/**
 * Hero Section Meta Box
 */
function earlystart_careers_hero_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_careers_hero_meta', 'earlystart_careers_hero_nonce' );
 ...
 */
function earlystart_careers_culture_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_careers_culture_meta', 'earlystart_careers_culture_nonce' );
 ...
 */
function earlystart_careers_openings_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_careers_openings_meta', 'earlystart_careers_openings_nonce' );
 ...
 */
function earlystart_careers_cta_meta_box_render( $post ) {
	wp_nonce_field( 'earlystart_careers_cta_meta', 'earlystart_careers_cta_nonce' );
 ...
 */
function earlystart_save_careers_page_meta( $post_id ) {
	...
	$meta_boxes = array(
		'earlystart_careers_hero_nonce' => array(
		...
		'earlystart_careers_culture_nonce' => array(
		...
		'earlystart_careers_openings_nonce' => array(
		...
		'earlystart_careers_cta_nonce' => array(
...
add_action( 'save_post', 'earlystart_save_careers_page_meta' );

/**
 * Seed default values for Careers page when template is first applied
 */
function earlystart_seed_careers_page_defaults( $post_id ) {
	// Check if this is a page
	if ( get_post_type( $post_id ) !== 'page' ) {
		return;
	}
	...
	$defaults = array(
		...
		'careers_hero_description' => 'We don\'t just hire staff; we invest in educators. At Early Start, you\'ll find a supportive community, career pathways, and the resources you need to change lives.',
		'careers_hero_button_text' => 'View Current Openings',
		'careers_hero_button_url'  => '#openings',

		'careers_culture_title'       => 'Why Early Start?',
...
add_action( 'save_post', 'earlystart_seed_careers_page_defaults', 5 );
