...
function earlystart_home_page_meta_boxes() {
	...
	add_meta_box(
		'chroma-home-hero',
		__( 'Home: Hero Section', 'earlystart-early-learning' ),
	...
	add_meta_box(
		...
		__( 'Home: Prismpath Section', 'earlystart-early-learning' ),
	...
	add_meta_box(
		...
		__( 'Home: Locations Preview', 'earlystart-early-learning' ),
	...
	add_meta_box(
		'chroma-home-faq',
		__( 'Home: FAQ Section', 'earlystart-early-learning' ),
	...
	add_meta_box(
		...
		__( 'Home: Complex Data (JSON)', 'earlystart-early-learning' ),
