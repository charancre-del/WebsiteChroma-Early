...
function earlystart_get_meta_description_value()
{
    ...
    if (is_front_page()) {
        ...
        if (empty($description)) {
            $description = $is_spanish
                ...
                : get_bloginfo('name') . ' provides pediatric therapy services across Metro Atlanta, including autism assessment, behavioral assessment, ADHD assessment, OT assessment, ABA therapy, speech therapy, and occupational therapy.';
        }
    ...
    return 'Chroma Early Start provides pediatric therapy services across Metro Atlanta, including autism assessment, behavioral assessment, ADHD assessment, OT assessment, ABA therapy, speech therapy, and occupational therapy.';
}
