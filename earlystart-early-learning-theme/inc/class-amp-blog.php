...
class earlystart_AMP_Blog
{
    ...
    public static function get_theme_colors() {
        return apply_filters('earlystart_amp_colors', [
            'brand_ink'     => get_theme_mod('earlystart_brand_ink', '#263238'),
            'brand_cream'   => get_theme_mod('earlystart_brand_cream', '#FFFCF8'),
            'brand_navy'    => get_theme_mod('earlystart_brand_navy', '#4A6C7C'),
            'earlystart_red'    => get_theme_mod('earlystart_primary_color', '#A84B38'),
            'earlystart_blue'   => get_theme_mod('earlystart_accent_color', '#4A6C7C'),
            'earlystart_green'  => '#4A7C59',
            'earlystart_yellow' => '#C2A024',
        ]);
    }
...
<head>
    ...
    <style amp-custom>
        :root {
            ...
            --chroma-red: <?php echo esc_attr($colors['earlystart_red']); ?>;
            --chroma-blue: <?php echo esc_attr($colors['earlystart_blue']); ?>;
        }
