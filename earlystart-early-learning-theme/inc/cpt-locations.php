...
{
	$labels = array(
		'name' => _x('Locations', 'Post Type General Name', 'earlystart-early-learning'),
		'singular_name' => _x('Location', 'Post Type Singular Name', 'earlystart-early-learning'),
		'menu_name' => __('Locations', 'earlystart-early-learning'),
		'all_items' => __('All Locations', 'earlystart-early-learning'),
		'add_new_item' => __('Add New Location', 'earlystart-early-learning'),
		'edit_item' => __('Edit Location', 'earlystart-early-learning'),
		'view_item' => __('View Location', 'earlystart-early-learning'),
	);

	$args = array(
		'label' => __('Location', 'earlystart-early-learning'),
		'labels' => $labels,
...
{
	$labels = array(
		'name' => _x('Location Regions', 'taxonomy general name', 'earlystart-early-learning'),
		'singular_name' => _x('Location Region', 'taxonomy singular name', 'earlystart-early-learning'),
		'search_items' => __('Search Location Regions', 'earlystart-early-learning'),
		'all_items' => __('All Location Regions', 'earlystart-early-learning'),
		'parent_item' => __('Parent Region', 'earlystart-early-learning'),
		'parent_item_colon' => __('Parent Region:', 'earlystart-early-learning'),
		'edit_item' => __('Edit Region', 'earlystart-early-learning'),
		'update_item' => __('Update Region', 'earlystart-early-learning'),
		'add_new_item' => __('Add New Region', 'earlystart-early-learning'),
		'new_item_name' => __('New Region Name', 'earlystart-early-learning'),
		'menu_name' => __('Location Regions', 'earlystart-early-learning'),
	);
	...
	register_taxonomy(
		...
		array(
			...
			'rewrite' => false,
			'default_term' => array(
				'name' => __('Uncategorized Locations', 'earlystart-early-learning'),
...
function earlystart_location_admin_columns($columns)
{
	...
	$new_columns['capacity'] = __('Capacity', 'earlystart-early-learning');
...
function earlystart_location_region_add_form_fields()
{
	...
	<div class="form-field">
		<label for="region_color_bg"><?php _e('Background Color Class', 'earlystart-early-learning'); ?></label>
		<input type="text" name="region_color_bg" id="region_color_bg" value="chroma-greenLight"
			placeholder="e.g., chroma-greenLight">
		<p class="description">
			<?php _e('Tailwind background color class (e.g., chroma-greenLight, chroma-redLight, chroma-blueLight, chroma-yellowLight, chroma-purpleLight, chroma-orangeLight, chroma-tealLight)', 'earlystart-early-learning'); ?>
		</p>
	</div>
	<div class="form-field">
		<label for="region_color_text"><?php _e('Text Color Class', 'earlystart-early-learning'); ?></label>
		<input type="text" name="region_color_text" id="region_color_text" value="chroma-green"
			placeholder="e.g., chroma-green">
		<p class="description">
			<?php _e('Tailwind text color class (e.g., chroma-green, chroma-red, chroma-blue, chroma-yellow, chroma-purple, chroma-orange, chroma-teal)', 'earlystart-early-learning'); ?>
		</p>
	</div>
	<div class="form-field">
		<label for="region_color_border"><?php _e('Border Color Class', 'earlystart-early-learning'); ?></label>
		<input type="text" name="region_color_border" id="region_color_border" value="chroma-green"
			placeholder="e.g., chroma-green">
		<p class="description">
			<?php _e('Tailwind border color class (e.g., chroma-green, chroma-red, chroma-blue, chroma-yellow, chroma-purple, chroma-orange, chroma-teal)', 'earlystart-early-learning'); ?>
		</p>
	</div>
	<?php
}
...
function earlystart_location_region_edit_form_fields($term)
{
	...
	?>
	<tr class="form-field">
		<th scope="row"><label for="region_color_bg"><?php _e('Background Color Class', 'earlystart-early-learning'); ?></label>
		</th>
		<td>
	...
	<tr class="form-field">
		<th scope="row"><label for="region_color_text"><?php _e('Text Color Class', 'earlystart-early-learning'); ?></label></th>
		<td>
	...
	<tr class="form-field">
		<th scope="row"><label for="region_color_border"><?php _e('Border Color Class', 'earlystart-early-learning'); ?></label>
		</th>
		<td>
...
function earlystart_location_custom_fields_meta_box()
{
	add_meta_box(
		...
		__('Location Details', 'earlystart-early-learning'),
...
function earlystart_render_location_custom_fields_meta_box($post)
{
	...
	<div class="chroma-meta-section">
		<h4><?php _e('Hero Section', 'earlystart-early-learning'); ?></h4>
		...
		<div class="chroma-meta-field">
			<label for="location_hero_review_text"><?php _e('Hero Review Text', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Review text displayed in the floating badge (leave empty to hide)', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_hero_review_author"><?php _e('Hero Review Author', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Author of the review (defaults to "Parent Review" if empty)', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_hero_gallery"><?php _e('Hero Image Gallery (URLs)', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Enter image URLs (one per line). If provided, these will display as a carousel in the hero section. Leave empty to use the featured image.', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_virtual_tour_embed"><?php _e('Virtual Tour Embed Code', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Paste the full embed code for your virtual tour. If provided, this will display on the location page. If empty, no space will be created on the page.', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_tagline"><?php _e('Tagline', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Main tagline for this location (last 2 words will be italicized)', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_description"><?php _e('Description', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Brief description shown in hero section', 'earlystart-early-learning'); ?></small>
		</div>
	</div>

	<div class="chroma-meta-section">
		<h4><?php _e('Location Stats', 'earlystart-early-learning'); ?></h4>

		<div class="chroma-meta-field">
			<label for="location_ages_served"><?php _e('Ages Served', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Age range served at this location', 'earlystart-early-learning'); ?></small>
		</div>
	...
	<div class="chroma-meta-field">
		...
		<div class="chroma-meta-field">
			...
			<small><?php _e('Google rating for this location (e.g., 4.9)', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_hours"><?php _e('Hours', 'earlystart-early-learning'); ?></label>
			<input type="text" id="location_hours" name="location_hours" value="<?php echo esc_attr($hours); ?>"
				placeholder="e.g., 7am - 6pm" />
			<small><?php _e('Operating hours (Mon-Fri)', 'earlystart-early-learning'); ?></small>
		</div>
	</div>
	...
	<div class="chroma-meta-section">
		...
		<div class="chroma-meta-field">
			<label for="location_director_bio"><?php _e('Director Bio', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Brief bio/welcome message from the director', 'earlystart-early-learning'); ?></small>
		</div>
	...
	<div class="chroma-meta-section">
		<h4><?php _e('Address & Contact', 'earlystart-early-learning'); ?></h4>

		<div class="chroma-meta-field">
			<label for="location_address"><?php _e('Street Address', 'earlystart-early-learning'); ?></label>
		...
		<div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 10px;">
			...
			<div class="chroma-meta-field">
				<label for="location_state"><?php _e('State', 'earlystart-early-learning'); ?></label>
				<input type="text" id="location_state" name="location_state" value="<?php echo esc_attr($state); ?>"
					placeholder="GA" />
			</div>

			<div class="chroma-meta-field">
				<label for="location_zip"><?php _e('ZIP Code', 'earlystart-early-learning'); ?></label>
		...
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
			...
			<div class="chroma-meta-field">
				<label for="location_email"><?php _e('Email', 'earlystart-early-learning'); ?></label>
		...
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
			<div class="chroma-meta-field">
				...
				<small><?php _e('For map integration (optional)', 'earlystart-early-learning'); ?></small>
			</div>

			<div class="chroma-meta-field">
				<label for="location_longitude"><?php _e('Longitude', 'earlystart-early-learning'); ?></label>
	...
	<div class="chroma-meta-section">
		<h4><?php _e('Google Maps & GMB', 'earlystart-early-learning'); ?></h4>

		<div class="chroma-meta-field">
			<label for="location_gmb_url"><?php _e('Google My Business URL', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Direct URL to your Google My Business listing. Used by AI to enhance content generation.', 'earlystart-early-learning'); ?></small>
		</div>

		<div class="chroma-meta-field">
			<label for="location_maps_embed"><?php _e('Google Maps Embed Code', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Paste the full iframe embed code from Google Maps. Go to Google Maps → Share → Embed a map', 'earlystart-early-learning'); ?></small>
		</div>
	</div>
	...
	<div class="chroma-meta-section">
		...
		<div class="chroma-meta-field">
			...
			<small><?php _e('Enter one school name per line. These will be displayed on the location page.', 'earlystart-early-learning'); ?></small>
		</div>
	</div>

	<div class="chroma-meta-section">
		<h4><?php _e('Location SEO Content', 'earlystart-early-learning'); ?></h4>

		<div class="chroma-meta-field">
			<label for="location_seo_content_title"><?php _e('SEO Content Title', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Title for the location-specific content section (e.g., "Early Education and Care in [City], GA")', 'earlystart-early-learning'); ?></small>
		</div>
	...
	<div class="chroma-meta-section">
		<h4><?php _e('Location-Specific FAQs (LLM SEO)', 'earlystart-early-learning'); ?></h4>

		<div class="chroma-meta-field">
			<label for="location_faq_items"><?php _e('FAQ Items', 'earlystart-early-learning'); ?></label>
			...
			<small><?php _e('Enter FAQ items in format: Question|Answer (one per line). These appear in JSON endpoints for LLMs.', 'earlystart-early-learning'); ?></small>
		</div>
	</div>

	<div class="chroma-meta-section">
		<p><strong><?php _e('Note:', 'earlystart-early-learning'); ?></strong>
			<?php _e('Use the "Featured Image" box in the sidebar to set the hero image for this location. Programs available at this location can be managed from the Programs admin section.', 'earlystart-early-learning'); ?>
		</p>
	</div>
	<?php
}
