...
{
	$labels = array(
		'name' => _x('Programs', 'Post Type General Name', 'earlystart-early-learning'),
		'singular_name' => _x('Program', 'Post Type Singular Name', 'earlystart-early-learning'),
		'menu_name' => __('Programs', 'earlystart-early-learning'),
		'all_items' => __('All Programs', 'earlystart-early-learning'),
		'add_new_item' => __('Add New Program', 'earlystart-early-learning'),
		'edit_item' => __('Edit Program', 'earlystart-early-learning'),
		'view_item' => __('View Program', 'earlystart-early-learning'),
	);
	...
	$args = array(
		'label' => __('Program', 'earlystart-early-learning'),
		'labels' => $labels,
...
function earlystart_program_admin_columns($columns)
{
	...
	$new_columns['age_range'] = __('Age Range', 'earlystart-early-learning');
	$new_columns['locations'] = __('Locations', 'earlystart-early-learning');
...
function earlystart_program_title_placeholder($title)
{
	...
	if ('program' === $screen->post_type) {
		$title = __('e.g., Infant Care', 'earlystart-early-learning');
	}
	return $title;
}
...
function earlystart_program_meta_box()
{
	add_meta_box(
		...
		__('Program Anchor & SEO Intro', 'earlystart-early-learning'),
...
function earlystart_program_meta_box_render($post)
{
	...
	<p>
		<label for="program_anchor_slug"
			class="screen-reader-text"><?php esc_html_e('Program Anchor', 'earlystart-early-learning'); ?></label>
		<input type="text" id="program_anchor_slug" name="program_anchor_slug" value="<?php echo esc_attr($anchor); ?>"
			class="widefat" placeholder="<?php esc_attr_e('e.g., infant', 'earlystart-early-learning'); ?>" />
		<small><?php esc_html_e('Used for #anchors and homepage wizard links. Defaults to the slug.', 'earlystart-early-learning'); ?></small>
	</p>
	<p>
		<label for="program_seo_heading"
			class="screen-reader-text"><?php esc_html_e('SEO Heading', 'earlystart-early-learning'); ?></label>
		<input type="text" id="program_seo_heading" name="program_seo_heading" value="<?php echo esc_attr($heading); ?>"
			class="widefat" placeholder="<?php esc_attr_e('Program intro heading', 'earlystart-early-learning'); ?>" />
	</p>
	<p>
		<label for="program_seo_summary"
			class="screen-reader-text"><?php esc_html_e('SEO Summary', 'earlystart-early-learning'); ?></label>
		<textarea id="program_seo_summary" name="program_seo_summary" class="widefat" rows="3"
			placeholder="<?php esc_attr_e('Short overview that lives above the card', 'earlystart-early-learning'); ?>"><?php echo esc_textarea($summary); ?></textarea>
	</p>
	<p>
	...
	<p>
		<label for="program_meta_title"
			class="screen-reader-text"><?php esc_html_e('Meta Title', 'earlystart-early-learning'); ?></label>
		<input type="text" id="program_meta_title" name="program_meta_title" value="<?php echo esc_attr($meta_title); ?>"
			class="widefat" placeholder="<?php esc_attr_e('Custom title tag (optional)', 'earlystart-early-learning'); ?>" />
		<small><?php esc_html_e('Used on the program detail for search visibility.', 'earlystart-early-learning'); ?></small>
	</p>
	<p>
		...
		<textarea id="program_meta_description" name="program_meta_description" class="widefat" rows="3"
			placeholder="<?php esc_attr_e('1–2 sentence description for search snippets', 'earlystart-early-learning'); ?>"><?php echo esc_textarea($meta_desc); ?></textarea>
	</p>
	<p>
		<label for="program_faq_items"
			class="screen-reader-text"><?php esc_html_e('FAQ Items', 'earlystart-early-learning'); ?></label>
		<textarea id="program_faq_items" name="program_faq_items" class="widefat" rows="4"
			placeholder="<?php esc_attr_e('Question | Answer (one per line)', 'earlystart-early-learning'); ?>"><?php echo esc_textarea($faq_items); ?></textarea>
		<small><?php esc_html_e('Populate FAQ schema and on-page Q&A.', 'earlystart-early-learning'); ?></small>
	</p>
	<?php
}
...
function earlystart_program_locations_meta_box()
{
	add_meta_box(
		...
		__('Available at Locations', 'earlystart-early-learning'),
	...
	add_meta_box(
		...
		__('Program Details', 'earlystart-early-learning'),
	...
	add_meta_box(
		...
		__('Single Page Content', 'earlystart-early-learning'),
...
function earlystart_program_locations_meta_box_render($post)
{
	...
	?>
	<p><?php _e('Select the locations where this program is available:', 'earlystart-early-learning'); ?></p>
	<p style="margin-bottom: 10px;">
		<button type="button" id="chroma-toggle-all-locations" class="button button-secondary" style="margin-bottom: 5px;">
			<?php _e('Select All / Deselect All', 'earlystart-early-learning'); ?>
		</button>
	</p>
	<div id="chroma-locations-list"
		...
		<?php if (!empty($all_locations)): ?>
			...
			<?php endforeach; ?>
		<?php else: ?>
			<p><?php _e('No locations found. Please add locations first.', 'earlystart-early-learning'); ?></p>
		<?php endif; ?>
	</div>
...
function earlystart_program_details_meta_box_render($post)
{
	...
	<div class="chroma-program-field">
		<label for="program_icon"><?php _e('Program Icon/Emoji', 'earlystart-early-learning'); ?></label>
	...
	<div class="chroma-program-field">
		<label for="program_age_range"><?php _e('Age Range', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Age range badge shown on program card (e.g., "6w - 12mo", "1 Year", "4yr - 5yr")', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-program-field">
		<label for="program_features"><?php _e('Program Features', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Enter one feature per line. These will display with checkmarks on the program card.', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-program-field">
		<label for="program_cta_text"><?php _e('CTA Button Text', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Text for the call-to-action button (default: "Schedule Tour")', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-program-field">
		<label for="program_cta_link"><?php _e('CTA Button Link', 'earlystart-early-learning'); ?></label>
		<input type="text" id="program_cta_link" name="program_cta_link" value="<?php echo esc_attr($cta_link); ?>"
			placeholder="#tour" />
		<small><?php _e('URL or anchor link for the CTA button (default: "#tour")', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-program-field">
		<label for="program_lesson_plan_file"><?php _e('Lesson Plan File (URL)', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Paste the full URL to the PDF lesson plan. If set, a button will appear on the program page.', 'earlystart-early-learning'); ?></small>
	</div>
	...
	<div class="chroma-program-field">
		...
		<small><?php _e('Color theme for the program card hover effects and badges', 'earlystart-early-learning'); ?></small>
	</div>

	<p><strong><?php _e('Note:', 'earlystart-early-learning'); ?></strong>
		<?php _e('The program description shown on the card comes from the "Excerpt" field. The featured image is used as the card image.', 'earlystart-early-learning'); ?>
	</p>
	<?php
}
...
function earlystart_program_single_page_meta_box_render($post)
{
	...
	<div class="chroma-single-field">
		<label for="program_hero_title"><?php _e('Hero Title', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Main heading on single program page (defaults to program title if empty)', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-single-field">
		<label for="program_hero_description"><?php _e('Hero Description', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Description paragraph in hero section', 'earlystart-early-learning'); ?></small>
	</div>
	...
	<div class="chroma-single-field">
		<label for="program_prism_title"><?php _e('Prism Section Title', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Title for the Prismpath focus section', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-single-field">
		<label for="program_prism_description"><?php _e('Prism Description', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Description explaining the program\'s Prismpath focus', 'earlystart-early-learning'); ?></small>
	</div>
	...
	<div class="chroma-single-field">
		<label for="program_prism_focus_items"><?php _e('Focus Items', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Bullet points explaining the focus. One per line.', 'earlystart-early-learning'); ?></small>
	</div>
	...
	<div class="chroma-single-field">
		<label for="program_schedule_title"><?php _e('Schedule Section Title', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Title for the schedule section', 'earlystart-early-learning'); ?></small>
	</div>

	<div class="chroma-single-field">
		<label for="program_schedule_items"><?php _e('Schedule Items', 'earlystart-early-learning'); ?></label>
		...
		<small><?php _e('Format: Badge|Title|Description (one per line). Badge can be AM, Mid, PM, or any text.', 'earlystart-early-learning'); ?></small>
	</div>

	<p><strong><?php _e('Note:', 'earlystart-early-learning'); ?></strong>
		<?php _e('The featured image is used as the hero image on the single program page.', 'earlystart-early-learning'); ?></p>
	<?php
}
