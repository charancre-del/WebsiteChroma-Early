...
<main class="flex-grow flex flex-col items-center justify-center text-center px-4">
  ...
  <h1 class="text-4xl md:text-5xl font-serif font-bold text-brand-ink mb-6">
    <?php _e('Ruh-roh! This page is playing hide-and-seek.', 'earlystart-early-learning'); ?></h1>
  <p class="text-lg text-brand-ink max-w-md mb-10">
    <?php _e('We\'ve checked the toy bin, looked under the rugs, and even asked the goldfish, but we can\'t find this page anywhere. It must be really good at hiding!', 'earlystart-early-learning'); ?>
  </p>
